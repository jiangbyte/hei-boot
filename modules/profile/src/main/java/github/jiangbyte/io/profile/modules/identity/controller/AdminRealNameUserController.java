 ...
 * Author: Charlie
 */
@Tag(name = "管理端用户实名认证 API")
@RestController
@RequestMapping("/api")
@RequiredArgsConstructor
public class AdminRealNameUserController {
    ...
    @GetMapping("/v1/admin/profile/identity/status")
    ...
    @PostMapping("/v1/admin/real-name/case/init-third-party")
    ...
    @PostMapping("/v1/admin/real-name/case/callback")
    ...
    @GetMapping("/v1/admin/real-name/case/my-page")
