/*
 HEI Boot MySQL 8 schema + seed (SOURCE OF TRUTH)
 Maintain table structure, seed data, and column/table COMMENT here.
 After editing: python scripts/generate_column_labels.py
*/
SET NAMES utf8mb4;
...
CREATE TABLE `cg_test_activity` (
  ...
  `created_by` varchar(64) COMMENT '创建人（账户ID）',
  `updated_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '更新时间',
  `updated_by` varchar(64) COMMENT '更新人（账户ID）',
  `owner_dept_id` varchar(64) COMMENT '所属部门ID（数据范围）'
) COMMENT='代码生成测试-活动';
-- ----------------------------
...
CREATE TABLE `cg_test_order` (
  ...
  `total_amount` numeric NOT NULL COMMENT '订单金额',
...
CREATE TABLE `cg_test_order_item` (
  ...
  `unit_price` numeric NOT NULL COMMENT '单价',
...
CREATE TABLE `profile_user_admin` (
  `account_id` varchar(64) NOT NULL COMMENT '关联系统账号ID（主键）',
  `nickname` varchar(64) COMMENT '管理端显示昵称',
  `avatar` text COMMENT '头像 object_name 或 URL',
...
CREATE TABLE `profile_user_portal` (
  `account_id` varchar(64) NOT NULL COMMENT '关联系统账号ID（主键）',
  `nickname` varchar(64) COMMENT '门户端显示昵称',
  `avatar` text COMMENT '头像 object_name 或 URL',
  `signature` text COMMENT '个性签名',
  `phone` varchar(32) COMMENT '绑定手机号',
  `email` varchar(128) COMMENT '绑定邮箱',
...
CREATE TABLE `profile_identity` (
  `account_id` varchar(64) NOT NULL COMMENT '关联系统账号ID（主键）',
  `status` varchar(32) NOT NULL DEFAULT 'UNVERIFIED' COMMENT '认证状态：UNVERIFIED/PENDING/VERIFIED/REJECTED',
  `document_type` varchar(32) COMMENT '证件类型：ID_CARD/PASSPORT 等',
  `real_name_cipher` text COMMENT '真实姓名密文（加密存储）',
  `document_no_cipher` text COMMENT '证件号码密文（加密存储）',
  `document_no_hash` varchar(128) COMMENT '证件号码哈希（用于脱敏检索）',
  `verify_channel` varchar(32) COMMENT '认证通道：THIRD_PARTY/MANUAL',
  `provider` varchar(32) COMMENT '第三方服务提供方',
  `provider_order_no` varchar(128) COMMENT '第三方业务订单号',
  `verified_at` datetime(6) COMMENT '实名认证通过时间',
  `source_case_id` varchar(64) COMMENT '来源实名工单ID',
  `revoked_at` datetime(6) COMMENT '实名认证撤销时间',
  `revoked_by` varchar(64) COMMENT '撤销操作人账户ID',
  `created_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '创建时间',
  `created_by` varchar(64) COMMENT '创建人（账户ID）',
  `updated_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '更新时间',
  `updated_by` varchar(64) COMMENT '更新人（账户ID）'
...
CREATE TABLE `real_name_case` (
  `case_id` varchar(64) NOT NULL COMMENT '实名工单ID（主键）',
  `business_type` varchar(64) NOT NULL COMMENT '业务类型：ACCOUNT_VERIFY/ACCOUNT_RECOVERY',
  `verify_channel` varchar(32) NOT NULL COMMENT '认证通道：THIRD_PARTY/MANUAL',
  `status` varchar(32) NOT NULL COMMENT '工单状态：PENDING/APPROVED/REJECTED 等',
  `account_id` varchar(64) COMMENT '账户ID',
  `target_account_hint_cipher` text COMMENT '目标账户提示信息密文',
  `applicant_contact_cipher` text COMMENT '申请人联系方式密文',
  `document_type` varchar(32) COMMENT '证件类型：ID_CARD/PASSPORT 等',
  `real_name_cipher` text COMMENT '真实姓名密文',
  `document_no_cipher` text COMMENT '证件号码密文',
  `document_no_hash` varchar(128) COMMENT '证件号码哈希',
  `attachment_ids` text COMMENT '附件ID列表（JSON数组）',
  `payload_cipher` text COMMENT '扩展业务载荷密文',
  `handler_dept_id` varchar(64) COMMENT '受理部门ID',
  `provider` varchar(32) COMMENT '第三方服务提供方',
  `provider_order_no` varchar(128) COMMENT '第三方业务订单号',
  `submitter_id` varchar(64) COMMENT '提交人账户ID',
  `reviewer_id` varchar(64) COMMENT '审核人账户ID',
  `reviewed_at` datetime(6) COMMENT '审核完成时间',
...
CREATE TABLE `real_name_case_record` (
  `record_id` varchar(64) NOT NULL COMMENT '工单流水ID（主键）',
  `case_id` varchar(64) NOT NULL COMMENT '关联实名工单ID',
  `account_id` varchar(64) COMMENT '账户ID',
  `business_type` varchar(64) NOT NULL COMMENT '业务类型',
  `action` varchar(32) NOT NULL COMMENT '流水动作：SUBMIT/APPROVE/REJECT/REVOKE 等',
  `status_before` varchar(32) COMMENT '动作前工单状态',
  `status_after` varchar(32) COMMENT '动作后工单状态',
  `verify_channel` varchar(32) COMMENT '认证通道：THIRD_PARTY（三方）/ MANUAL（人工）',
  `provider` varchar(32) COMMENT '第三方服务提供方',
  `operator_id` varchar(64) COMMENT '操作人账户ID',
  `dept_id` varchar(64) COMMENT '操作所属部门ID',
...
CREATE TABLE `sys_account` (
  `id` varchar(64) NOT NULL COMMENT '主键ID',
  `password_hash` varchar(255) NOT NULL COMMENT '登录密码哈希值（bcrypt 等）',
  `account_type` varchar(32) NOT NULL COMMENT '账户类型：ADMIN（管理端）/ PORTAL（门户端）',
  `account_status` varchar(32) NOT NULL COMMENT '账户状态：ACTIVE（正常）/ LOCKED（锁定）/ CANCELLED（已注销）',
  `cancelled_at` datetime(6) COMMENT '账号注销完成时间',
  `cancelled_by` varchar(64) COMMENT '执行注销的操作人账户ID',
  `cancel_reason` text COMMENT '注销原因说明',
  `cancel_notify_email` varchar(128) COMMENT '注销前快照：通知邮箱（身份清理前保留）',
  `cancel_notify_phone` varchar(32) COMMENT '注销前快照：通知手机号（身份清理前保留）',
  `last_login_ip` varchar(64) COMMENT '上一次成功登录 IP',
  `last_login_address` varchar(255) COMMENT '上一次成功登录地理位置',
  `last_login_time` datetime(6) COMMENT '上一次成功登录时间',
  `last_login_device` text COMMENT '上一次成功登录设备标识',
  `latest_login_ip` varchar(64) COMMENT '最近一次成功登录 IP',
  `latest_login_address` varchar(255) COMMENT '最近一次成功登录地理位置',
  `latest_login_time` datetime(6) COMMENT '最近一次成功登录时间',
  `latest_login_device` text COMMENT '最近一次成功登录设备标识',
  `created_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '创建时间',
  `created_by` varchar(64) COMMENT '创建人（账户ID）',
  `updated_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '更新时间',
  `updated_by` varchar(64) COMMENT '更新人（账户ID）'
...
CREATE TABLE `sys_account_identity` (
  ...
  `identity_type` varchar(32) NOT NULL COMMENT '身份类型：USERNAME/EMAIL/PHONE 等',
  `identifier` varchar(128) NOT NULL COMMENT '登录标识值（用户名/邮箱/手机号）',
  `verified` tinyint(1) NOT NULL COMMENT '标识是否已完成验证：1 是 / 0 否',
  `is_primary` tinyint(1) NOT NULL COMMENT '是否主登录标识：1 主标识 / 0 次标识',
  `bind_status` varchar(32) NOT NULL COMMENT '绑定状态：BOUND/UNBOUND/PENDING 等',
  `created_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '创建时间',
  `created_by` varchar(64) COMMENT '创建人（账户ID）',
  `updated_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '更新时间',
  `updated_by` varchar(64) COMMENT '更新人（账户ID）'
) COMMENT='账号身份标识（手机/邮箱/登录名）';
-- ----------------------------
...
CREATE TABLE `sys_account_oauth_binding` (
  `id` varchar(64) NOT NULL COMMENT '主键ID',
  `account_id` varchar(64) NOT NULL COMMENT '账户ID',
  `provider` varchar(32) NOT NULL COMMENT 'OAuth 提供方：wechat/github/google 等',
  `open_id` varchar(128) NOT NULL COMMENT '第三方平台 OpenID',
  `union_id` varchar(128) COMMENT '第三方平台 UnionID（跨应用统一标识）',
  `nickname` varchar(128) COMMENT '第三方账号昵称快照',
  `avatar` text COMMENT '第三方账号头像 URL 快照',
  `raw_profile` json NOT NULL DEFAULT ('{}') COMMENT '第三方原始资料（JSON）',
...
CREATE TABLE `sys_account_password_history` (
  `id` varchar(64) NOT NULL COMMENT '主键ID',
  `account_id` varchar(64) NOT NULL COMMENT '账户ID',
  `password_hash` varchar(255) NOT NULL COMMENT '密码哈希值（不可逆）',
  `changed_by` varchar(64) COMMENT '密码变更操作人（账户ID 或 system）',
  `change_reason` varchar(64) COMMENT '变更原因：register/admin_reset/self_reset/password_expired',
...
CREATE TABLE `sys_alert_log` (
  `id` varchar(64) NOT NULL COMMENT '主键ID',
  `rule_name` varchar(64) NOT NULL COMMENT '触发告警的规则名称',
  `severity` varchar(16) NOT NULL COMMENT '严重级别：INFO/WARNING/CRITICAL',
  `summary` varchar(255) NOT NULL COMMENT '告警摘要（展示用）',
  `details` json COMMENT '告警详情上下文（JSON）',
  `notified_via` varchar(64) COMMENT '通知渠道：email/webhook 等',
...
CREATE TABLE `sys_banner` (
  ...
  `image` varchar(500) NOT NULL COMMENT 'Banner 图片 object_name（由服务层解析访问 URL）',
  `url` varchar(500) COMMENT '点击跳转链接地址',
  `link_type` varchar(16) NOT NULL COMMENT '链接类型（字典 BANNER_LINK_TYPE）',
  `summary` varchar(500) COMMENT '摘要',
  `description` text COMMENT '描述说明',
  `category` varchar(32) NOT NULL COMMENT 'Banner 分类（字典 BANNER_CATEGORY）',
  `type` varchar(32) NOT NULL COMMENT 'Banner 类型（字典 BANNER_TYPE）',
  `position` varchar(32) NOT NULL COMMENT '展示位置（字典 BANNER_POSITION）',
  `target_account_types` json NOT NULL COMMENT '可见账户类型：ADMIN/PORTAL（JSON 数组）',
  `sort` int NOT NULL COMMENT '排序号（越小越靠前）',
  `interaction_count` bigint NOT NULL COMMENT '用户交互次数统计',
  `status` varchar(32) NOT NULL COMMENT 'Banner 状态：ENABLED/DISABLED 等',
  `start_at` datetime(6) COMMENT '开始展示时间',
  `end_at` datetime(6) COMMENT '结束展示时间',
  `created_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '创建时间',
  `created_by` varchar(64) COMMENT '创建人（账户ID）',
  `updated_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '更新时间',
  `updated_by` varchar(64) COMMENT '更新人（账户ID）'
...
CREATE TABLE `sys_client_module` (
  ...
  `code` varchar(64) NOT NULL COMMENT '编码',
  `account_type` varchar(32) NOT NULL COMMENT '适用账户体系：ADMIN/PORTAL',
  `icon` varchar(255) COMMENT '图标标识',
  `color` varchar(32) COMMENT '颜色值',
  `sort` int NOT NULL COMMENT '排序号（越小越靠前）',
  `status` varchar(32) NOT NULL COMMENT '模块状态：ENABLED/DISABLED',
  `description` text COMMENT '客户端模块描述',
  `extra` json NOT NULL COMMENT '扩展信息（JSON）',
  `created_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '创建时间',
  `created_by` varchar(64) COMMENT '创建人（账户ID）',
  `updated_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '更新时间',
...
CREATE TABLE `sys_client_resource` (
  `id` varchar(64) NOT NULL COMMENT '主键ID',
  `parent_id` varchar(64) COMMENT '父级客户端资源ID',
  `code` varchar(64) NOT NULL COMMENT '编码',
  `name` varchar(64) NOT NULL COMMENT '名称',
  `resource_type` varchar(32) NOT NULL COMMENT '资源类型：MENU/BUTTON/API 等',
  `module_id` varchar(64) COMMENT '所属客户端模块ID',
  `path` varchar(255) COMMENT '前端路由路径',
  `component` varchar(255) COMMENT '前端组件路径',
  `redirect` varchar(255) COMMENT '路由重定向地址',
  `icon` varchar(255) COMMENT '图标标识',
  `color` varchar(32) COMMENT '颜色值',
  `href` varchar(255) COMMENT '外链跳转地址',
  `sort` int NOT NULL COMMENT '排序号（越小越靠前）',
  `is_visible` tinyint(1) NOT NULL COMMENT '是否可见：1 可见 / 0 隐藏',
  `is_cache` tinyint(1) NOT NULL COMMENT '是否缓存路由：1 缓存 / 0 不缓存',
  `is_affix` tinyint(1) NOT NULL COMMENT '是否固定标签页：1 固定 / 0 不固定',
  `status` varchar(32) NOT NULL COMMENT '资源状态：ENABLED/DISABLED',
  `description` text COMMENT '客户端资源描述',
  `layout` varchar(255) COMMENT '页面布局类型',
  `extra` json NOT NULL COMMENT '扩展信息（JSON）',
  `created_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '创建时间',
  `created_by` varchar(64) COMMENT '创建人（账户ID）',
  `updated_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '更新时间',
...
CREATE TABLE `sys_codegen_field` (
  `id` varchar(64) NOT NULL COMMENT '主键ID',
  `plan_id` varchar(64) NOT NULL COMMENT '所属代码生成方案ID',
  `table_role` varchar(16) NOT NULL COMMENT '表角色：MASTER/SUB 等',
  `column_name` varchar(128) NOT NULL COMMENT '数据库列名',
  `label` varchar(255) COMMENT '字段展示标签（通常取自表注释）',
  `db_type` varchar(128) NOT NULL COMMENT '数据库物理类型',
  `value_type` varchar(64) NOT NULL COMMENT '语义值类型：str/int/bool/datetime/dict 等',
  `ui_type` varchar(64) NOT NULL COMMENT '前端 UI 类型：string/number/boolean 等',
  `widget` varchar(32) NOT NULL COMMENT '表单控件类型',
  `dict_code` varchar(128) COMMENT '关联数据字典编码',
  `query_operator` varchar(32) COMMENT '列表查询运算符：eq/like/between 等',
  ...
  `max_length` int COMMENT '字段最大长度限制',
  `sort` int NOT NULL COMMENT '排序号（越小越靠前）',
  `created_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '创建时间',
  `created_by` varchar(64) COMMENT '创建人（账户ID）',
  `updated_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '更新时间',
...
INSERT INTO `sys_codegen_field` VALUES ('2086441952623603714', '2086441951554056193', 'MAIN', 'max_participants', '最大参与人数', 'int4', 'int', 'number', 'number', NULL, 'EQ', 0, 0, 0, 0, 0, 0, 0, 0, NULL, 11, '2026-08-09 13:18:20.21131', '1', '2026-08-09 13:18:20.21131', '1');
INSERT INTO `sys_codegen_field` VALUES ('2086441952690712577', '2086441951554056193', 'MAIN', 'price', '报名费用', 'numeric', 'float', 'number', 'number', NULL, NULL, 0, 0, 0, 0, 0, 0, 0, 0, NULL, 12, '2026-08-09 13:18:20.21131', '1', '2026-08-09 13:18:20.21131', '1');
INSERT INTO `sys_codegen_field` VALUES ('2086441952757821442', '2086441951554056193', 'MAIN', 'is_public', '是否公开', 'bool', 'bool', 'boolean', 'switch', NULL, 'EQ', 0, 0, 0, 0, 0, 0, 0, 0, NULL, 13, '2026-08-09 13:18:20.21131', '1', '2026-08-09 13:18:20.21131', '1');
INSERT INTO `sys_codegen_field` VALUES ('2086441952829124610', '2086441951554056193', 'MAIN', 'need_approval', '是否需要审批', 'bool', 'bool', 'boolean', 'switch', NULL, 'EQ', 0, 0, 0, 0, 0, 0, 0, 0, NULL, 14, '2026-08-09 13:18:20.21131', '1', '2026-08-09 13:18:20.21131', '1');
...
INSERT INTO `sys_codegen_field` VALUES ('2086449497295740930', '2086449496716926978', 'MAIN', 'sort', '排序', 'int4', 'int', 'number', 'number', NULL, 'EQ', 0, 0, 0, 0, 0, 0, 0, 0, NULL, 7, '2026-08-09 13:48:19.093754', '1', '2026-08-09 13:48:19.093754', '1');
INSERT INTO `sys_codegen_field` VALUES ('2086449497497067522', '2086449496716926978', 'MAIN', 'is_visible', '是否显示', 'bool', 'bool', 'boolean', 'switch', NULL, 'EQ', 0, 0, 0, 0, 0, 0, 0, 0, NULL, 8, '2026-08-09 13:48:19.093754', '1', '2026-08-09 13:48:19.093754', '1');
...
CREATE TABLE `sys_codegen_plan` (
  ...
  `gen_type` varchar(32) NOT NULL COMMENT '生成类型：CRUD/TREE/SUB_TABLE 等',
  `author` varchar(64) NOT NULL COMMENT '作者',
  `description` text COMMENT '代码生成方案描述',
  `table_name` varchar(128) NOT NULL COMMENT '主表数据库名',
  `pk_column` varchar(128) NOT NULL COMMENT '主表主键列名',
  `entity_name` varchar(128) NOT NULL COMMENT '生成的主实体类名',
  `module_path` varchar(255) NOT NULL COMMENT '后端模块包路径',
  `business_name` varchar(128) NOT NULL COMMENT '主业务中文名',
  `api_prefix` varchar(255) NOT NULL COMMENT 'REST API 路径前缀',
  `permission_prefix` varchar(128) NOT NULL COMMENT '权限标识前缀',
  `resource_module_id` varchar(64) COMMENT '挂载的资源模块ID',
  `parent_resource_id` varchar(64) COMMENT '挂载的父菜单资源ID',
  `menu_name` varchar(64) NOT NULL COMMENT '生成菜单名称',
  `menu_path` varchar(255) NOT NULL COMMENT '生成菜单路由路径',
  `component_path` varchar(255) NOT NULL COMMENT '生成前端组件路径',
  `icon` varchar(255) COMMENT '图标标识',
  `sort` int NOT NULL COMMENT '排序号（越小越靠前）',
  `tree_parent_field` varchar(128) COMMENT '树表父级字段名',
  `tree_label_field` varchar(128) COMMENT '树节点展示字段名',
  `sub_table` varchar(128) COMMENT '子表数据库名',
  `sub_pk` varchar(128) COMMENT '子表主键列名',
  `sub_foreign_key` varchar(128) COMMENT '子表外键列名',
  `sub_entity_name` varchar(128) COMMENT '子实体类名',
  `sub_business_name` varchar(128) COMMENT '子业务中文名',
  `created_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '创建时间',
  `created_by` varchar(64) COMMENT '创建人（账户ID）',
  `updated_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '更新时间',
  `updated_by` varchar(64) COMMENT '更新人（账户ID）'
...
CREATE TABLE `sys_config` (
  `id` varchar(64) NOT NULL COMMENT '主键ID',
  `config_key` varchar(255) NOT NULL COMMENT '配置项唯一键',
  `config_value` text COMMENT '配置项值（按 value_type 解析）',
  `category` varchar(255) COMMENT '配置分类/分组',
  `remark` varchar(255) COMMENT '备注说明',
  `sort_code` int NOT NULL COMMENT '同分类下排序码',
  `value_type` varchar(32) NOT NULL COMMENT '值类型：STRING/JSON/BOOL/NUMBER',
  `label` varchar(128) COMMENT '配置项展示名称',
  `scope` varchar(32) COMMENT '作用域账户类型：GLOBAL/ADMIN/PORTAL',
  `scene` varchar(64) COMMENT '业务场景编码',
...
INSERT INTO `sys_config` VALUES ('7695727871068877789', 'AUDIT_ALERT_NOTIFY_EMAIL', 'TRUE', 'AUDIT_ALERT', '邮件通知', 2, 'BOOL', '邮件通知', NULL, NULL, 0, '{}', '2026-08-08 00:00:00', NULL, '2026-08-08 00:00:00', NULL);
...
INSERT INTO `sys_config` VALUES ('7812345678901234503', 'AUDIT_ALERT_BULK_DELETE_WINDOW_SECONDS', '300', 'AUDIT_ALERT', '批量删除检测窗口（秒）', 16, 'INT', '批量删除检测窗口（秒）', NULL, NULL, 0, '{}', '2026-08-22 00:00:00', NULL, '2026-08-22 00:00:00', NULL);
INSERT INTO `sys_config` VALUES ('7812345678901234504', 'AUDIT_ALERT_IP_ANOMALY_WINDOW_SECONDS', '900', 'AUDIT_ALERT', '异地 IP 检测窗口（秒）', 17, 'INT', '异地 IP 检测窗口（秒）', NULL, NULL, 0, '{}', '2026-08-22 00:00:00', NULL, '2026-08-22 00:00:00', NULL);
...
INSERT INTO `sys_config` VALUES ('7932896058923796364', 'MAIL_LOCAL_USE_STARTTLS', 'FALSE', 'MAIL', 'SMTP 使用 STARTTLS', 18, 'BOOL', 'SMTP 使用 STARTTLS', NULL, NULL, 0, '{}', '2026-08-08 00:00:00', NULL, '2026-08-08 00:00:00', NULL);
...
INSERT INTO `sys_config` VALUES ('7667316617799595990', 'AUDIT_ALERT_RULE_BULK_DELETE', 'TRUE', 'AUDIT_ALERT', '批量删除检测', 13, 'BOOL', '批量删除检测', NULL, NULL, 0, '{}', '2026-08-08 00:00:00', NULL, '2026-08-08 00:00:00', NULL);
...
INSERT INTO `sys_config` VALUES ('7564883844348625200', 'AUDIT_ALERT_RULE_IP_ANOMALY', 'TRUE', 'AUDIT_ALERT', 'IP 异常检测', 14, 'BOOL', 'IP 异常检测', NULL, NULL, 0, '{}', '2026-08-08 00:00:00', NULL, '2026-08-08 00:00:00', NULL);
INSERT INTO `sys_config` VALUES ('7965270553477718376', 'AUTH_LOGIN_ADMIN_ALLOW_PHONE', 'TRUE', 'AUTH_LOGIN', 'ADMIN 允许手机号登录', 13, 'BOOL', 'ADMIN 允许手机号登录', 'ADMIN', NULL, 0, '{}', '2026-08-08 00:00:00', NULL, '2026-08-08 00:00:00', '1');
...
INSERT INTO `sys_config` VALUES ('7645847924523510728', 'AUTH_REGISTER_PORTAL_REQUIRE_EMAIL', 'TRUE', 'AUTH_REGISTER', 'PORTAL 注册要求邮箱', 8, 'BOOL', 'PORTAL 注册要求邮箱', 'PORTAL', NULL, 0, '{}', '2026-08-08 00:00:00', NULL, '2026-08-08 00:00:00', NULL);
...
INSERT INTO `sys_config` VALUES ('7204221884041359188', 'AUDIT_ALERT_NOTIFY_CUSTOM_WEBHOOK', 'FALSE', 'AUDIT_ALERT', '自定义 Webhook 通知', 4, 'BOOL', '自定义 Webhook 通知', NULL, NULL, 0, '{}', '2026-08-08 00:00:00', NULL, '2026-08-08 00:00:00', NULL);
...
INSERT INTO `sys_config` VALUES ('7159687456156883406', 'PASSWORD_FORBID_WEAK_LIST', 'TRUE', 'AUTH_PASSWORD', '禁止弱密码库命中', 17, 'BOOL', '禁止弱密码库命中', NULL, NULL, 0, '{}', '2026-08-08 00:00:00', NULL, '2026-08-08 00:00:00', NULL);
INSERT INTO `sys_config` VALUES ('7107236720876061841', 'AUTH_REGISTER_ADMIN_ENABLED', 'FALSE', 'AUTH_REGISTER', 'ADMIN 开放注册', 1, 'BOOL', 'ADMIN 开放注册', 'ADMIN', NULL, 0, '{}', '2026-08-08 00:00:00', NULL, '2026-08-08 00:00:00', NULL);
INSERT INTO `sys_config` VALUES ('7312697174587677983', 'MAIL_LOCAL_USE_SSL', 'FALSE', 'MAIL', 'SMTP 使用 SSL', 17, 'BOOL', 'SMTP 使用 SSL', NULL, NULL, 0, '{}', '2026-08-08 00:00:00', NULL, '2026-08-08 00:00:00', NULL);
...
INSERT INTO `sys_config` VALUES ('7743096612050880755', 'PASSWORD_FORBID_USER_INFO', 'TRUE', 'AUTH_PASSWORD', '禁止包含用户信息', 14, 'BOOL', '禁止包含用户信息', NULL, NULL, 0, '{}', '2026-08-08 00:00:00', NULL, '2026-08-08 00:00:00', NULL);
...
INSERT INTO `sys_config` VALUES ('7640258913173401645', 'AUDIT_ALERT_ENABLED', 'TRUE', 'AUDIT_ALERT', '审计告警总开关', 1, 'BOOL', '审计告警总开关', NULL, NULL, 0, '{}', '2026-08-08 00:00:00', NULL, '2026-08-08 00:00:00', NULL);
INSERT INTO `sys_config` VALUES ('7259830455098789920', 'AUTH_REGISTER_PORTAL_ENABLED', 'TRUE', 'AUTH_REGISTER', 'PORTAL 开放注册', 6, 'BOOL', 'PORTAL 开放注册', 'PORTAL', NULL, 0, '{}', '2026-08-08 00:00:00', NULL, '2026-08-08 00:00:00', '1');
...
INSERT INTO `sys_config` VALUES ('7616410287911469795', 'AUTH_REGISTER_PORTAL_REQUIRE_PHONE', 'FALSE', 'AUTH_REGISTER', 'PORTAL 注册要求手机号', 7, 'BOOL', 'PORTAL 注册要求手机号', 'PORTAL', NULL, 0, '{}', '2026-08-08 00:00:00', NULL, '2026-08-08 00:00:00', NULL);
INSERT INTO `sys_config` VALUES ('7389279063701289685', 'AUTH_REGISTER_ADMIN_REQUIRE_PHONE', 'FALSE', 'AUTH_REGISTER', 'ADMIN 注册要求手机号', 2, 'BOOL', 'ADMIN 注册要求手机号', 'ADMIN', NULL, 0, '{}', '2026-08-08 00:00:00', NULL, '2026-08-08 00:00:00', NULL);
INSERT INTO `sys_config` VALUES ('7680761152547899501', 'AUTH_REGISTER_ADMIN_REQUIRE_EMAIL', 'FALSE', 'AUTH_REGISTER', 'ADMIN 注册要求邮箱', 3, 'BOOL', 'ADMIN 注册要求邮箱', 'ADMIN', NULL, 0, '{}', '2026-08-08 00:00:00', NULL, '2026-08-08 00:00:00', NULL);
...
INSERT INTO `sys_config` VALUES ('7833544856736466882', 'ACCOUNT_CANCEL_RETENTION_DAYS', '15', 'AUTH_PASSWORD', '注销账号保留天数', 25, 'INT', '注销账号保留天数', NULL, NULL, 0, '{}', '2026-08-09 00:00:00', NULL, '2026-08-09 00:00:00', NULL);
...
INSERT INTO `sys_config` VALUES ('7780925862931981131', 'MAIL_LOCAL_AUTH_REQUIRED', 'FALSE', 'MAIL', 'SMTP 是否需要认证', 16, 'BOOL', 'SMTP 是否需要认证', NULL, NULL, 0, '{}', '2026-08-08 00:00:00', NULL, '2026-08-08 00:00:00', NULL);
...
INSERT INTO `sys_config` VALUES ('7812345678901234501', 'APP_NAME', 'HEI', 'SYS', '应用名称', 3, 'STRING', '邮件/短信模板中的应用名称', NULL, NULL, 0, '{}', '2026-08-22 00:00:00', NULL, '2026-08-22 00:00:00', NULL);
INSERT INTO `sys_config` VALUES ('7812345678901234551', 'SITE_ICP_NUMBER', '', 'SYS', 'ICP 备案号', 4, 'STRING', 'ICP 备案号', NULL, NULL, 0, '{}', '2026-08-22 00:00:00', NULL, '2026-08-22 00:00:00', NULL);
INSERT INTO `sys_config` VALUES ('7812345678901234552', 'SITE_ICP_URL', 'https://beian.miit.gov.cn/', 'SYS', 'ICP 备案链接', 5, 'STRING', 'ICP 备案查询链接', NULL, NULL, 0, '{}', '2026-08-22 00:00:00', NULL, '2026-08-22 00:00:00', NULL);
INSERT INTO `sys_config` VALUES ('7812345678901234553', 'SITE_PSB_NUMBER', '', 'SYS', '公安备案号', 6, 'STRING', '公安备案号', NULL, NULL, 0, '{}', '2026-08-22 00:00:00', NULL, '2026-08-22 00:00:00', NULL);
...
INSERT INTO `sys_config` VALUES ('7812345678901234502', 'AUTH_OTP_TTL_SECONDS', '300', 'AUTH_TOKEN', '验证码有效期（秒）', 5, 'INT', '登录/注册/绑定等 OTP 有效期', NULL, NULL, 0, '{}', '2026-08-22 00:00:00', NULL, '2026-08-22 00:00:00', NULL);
...
INSERT INTO `sys_config` VALUES ('7264846649644584871', 'STORAGE_ALIYUN_BUCKET_PUBLIC', 'FALSE', 'STORAGE', '阿里云桶是否公开', 14, 'BOOL', NULL, NULL, NULL, 0, '{}', '2026-08-08 00:00:00', NULL, '2026-08-08 00:00:00', '1');
...
INSERT INTO `sys_config` VALUES ('7362777511165276641', 'STORAGE_TENCENT_BUCKET_PUBLIC', 'FALSE', 'STORAGE', '腾讯云桶是否公开', 20, 'BOOL', NULL, NULL, NULL, 0, '{}', '2026-08-08 00:00:00', NULL, '2026-08-08 00:00:00', '1');
...
INSERT INTO `sys_config` VALUES ('7525309778220488671', 'STORAGE_MINIO_BUCKET_PUBLIC', 'FALSE', 'STORAGE', 'MinIO 桶是否公开', 26, 'BOOL', NULL, NULL, NULL, 0, '{}', '2026-08-08 00:00:00', NULL, '2026-08-08 00:00:00', '1');
...
INSERT INTO `sys_config` VALUES ('7618985031080401037', 'STORAGE_RUSTFS_USE_SSL', 'FALSE', 'STORAGE', 'RustFS 是否 SSL', 45, 'BOOL', NULL, NULL, NULL, 0, '{}', '2026-08-09 00:00:00', NULL, '2026-08-09 00:00:00', '1');
...
INSERT INTO `sys_config` VALUES ('7507807560036605420', 'STORAGE_RUSTFS_BUCKET_PUBLIC', 'FALSE', 'STORAGE', 'RustFS 桶是否公开', 47, 'BOOL', NULL, NULL, NULL, 0, '{}', '2026-08-09 00:00:00', NULL, '2026-08-09 00:00:00', '1');
...
INSERT INTO `sys_config` VALUES ('7172687233882333188', 'AUDIT_ALERT_RULE_SENSITIVE_OPS', 'TRUE', 'AUDIT_ALERT', '敏感操作监控', 12, 'BOOL', '敏感操作监控', NULL, NULL, 0, '{}', '2026-08-08 00:00:00', NULL, '2026-08-08 00:00:00', NULL);
INSERT INTO `sys_config` VALUES ('7260823451582098683', 'AUDIT_ALERT_RULE_UNUSUAL_HOURS', 'TRUE', 'AUDIT_ALERT', '异常时间操作检测', 11, 'BOOL', '异常时间操作检测', NULL, NULL, 0, '{}', '2026-08-08 00:00:00', NULL, '2026-08-08 00:00:00', NULL);
...
INSERT INTO `sys_config` VALUES ('7154674032244377737', 'AUTH_LOGIN_ADMIN_ALLOW_EMAIL', 'TRUE', 'AUTH_LOGIN', 'ADMIN 允许邮箱登录', 15, 'BOOL', 'ADMIN 允许邮箱登录', 'ADMIN', NULL, 0, '{}', '2026-08-08 00:00:00', NULL, '2026-08-08 00:00:00', '1');
INSERT INTO `sys_config` VALUES ('7189190642894026372', 'AUTH_LOGIN_ADMIN_ALLOW_OTP', 'TRUE', 'AUTH_LOGIN', 'ADMIN 允许 OTP 登录', 17, 'BOOL', 'ADMIN 允许 OTP 登录', 'ADMIN', NULL, 0, '{}', '2026-08-08 00:00:00', NULL, '2026-08-08 00:00:00', '1');
...
INSERT INTO `sys_config` VALUES ('7961921801574207800', 'AUTH_LOGIN_PORTAL_ALLOW_PHONE', 'TRUE', 'AUTH_LOGIN', 'PORTAL 允许手机号登录', 21, 'BOOL', 'PORTAL 允许手机号登录', 'PORTAL', NULL, 0, '{}', '2026-08-08 00:00:00', NULL, '2026-08-08 00:00:00', '1');
...
INSERT INTO `sys_config` VALUES ('7643758115191934361', 'AUTH_LOGIN_PORTAL_ALLOW_EMAIL', 'TRUE', 'AUTH_LOGIN', 'PORTAL 允许邮箱登录', 23, 'BOOL', 'PORTAL 允许邮箱登录', 'PORTAL', NULL, 0, '{}', '2026-08-08 00:00:00', NULL, '2026-08-08 00:00:00', '1');
...
INSERT INTO `sys_config` VALUES ('7219205172797610985', 'AUTH_LOGIN_PORTAL_ALLOW_OTP', 'TRUE', 'AUTH_LOGIN', 'PORTAL 允许 OTP 登录', 25, 'BOOL', 'PORTAL 允许 OTP 登录', 'PORTAL', NULL, 0, '{}', '2026-08-08 00:00:00', NULL, '2026-08-08 00:00:00', '1');
...
INSERT INTO `sys_config` VALUES ('7812345678901234510', 'MAIL_TEMPLATE_RESET_PASSWORD_SUCCESS', '{"subject": "{{app_name}} 密码已重置", "body": "您好，账号 {{account}} 的密码已成功重置。如非本人操作，请尽快联系管理员。"}', 'MAIL_TEMPLATE', '重置密码成功邮件模板', 5, 'JSON', '重置密码成功邮件模板', NULL, 'RESET_PASSWORD_SUCCESS', 0, '{}', '2026-08-22 00:00:00', NULL, '2026-08-22 00:00:00', NULL);
INSERT INTO `sys_config` VALUES ('7812345678901234511', 'MAIL_TEMPLATE_PASSWORD_EXPIRING', '{"subject": "{{app_name}} 密码即将过期", "body": "您好，账号 {{account}} 的密码将在 {{remaining_days}} 天后过期，请尽快修改密码。"}', 'MAIL_TEMPLATE', '密码即将过期邮件模板', 6, 'JSON', '密码即将过期邮件模板', NULL, 'PASSWORD_EXPIRING', 0, '{}', '2026-08-22 00:00:00', NULL, '2026-08-22 00:00:00', NULL);
INSERT INTO `sys_config` VALUES ('7812345678901234512', 'MAIL_TEMPLATE_CHANGE_EMAIL_CODE', '{"subject": "{{app_name}} 修改邮箱验证码", "body": "您的修改邮箱验证码是 {{code}}，{{expire_minutes}} 分钟内有效。"}', 'MAIL_TEMPLATE', '修改邮箱验证码邮件模板', 21, 'JSON', '修改邮箱验证码邮件模板', NULL, 'CHANGE_EMAIL_CODE', 0, '{}', '2026-08-22 00:00:00', NULL, '2026-08-22 00:00:00', NULL);
INSERT INTO `sys_config` VALUES ('7812345678901234520', 'SMS_TEMPLATE_REGISTER_SUCCESS', '{"code": "", "content": "欢迎注册 {{app_name}}，账号 {{account}} 注册成功"}', 'SMS_TEMPLATE', '注册成功短信模板', 3, 'JSON', '注册成功短信模板', NULL, 'REGISTER_SUCCESS', 0, '{}', '2026-08-22 00:00:00', NULL, '2026-08-22 00:00:00', NULL);
INSERT INTO `sys_config` VALUES ('7812345678901234521', 'SMS_TEMPLATE_RESET_PASSWORD_CODE', '{"code": "", "content": "重置密码验证码 {{code}}，{{expire_minutes}} 分钟内有效"}', 'SMS_TEMPLATE', '重置密码验证码短信模板', 4, 'JSON', '重置密码验证码短信模板', NULL, 'RESET_PASSWORD_CODE', 0, '{}', '2026-08-22 00:00:00', NULL, '2026-08-22 00:00:00', NULL);
INSERT INTO `sys_config` VALUES ('7812345678901234522', 'SMS_TEMPLATE_RESET_PASSWORD_SUCCESS', '{"code": "", "content": "账号 {{account}} 密码已重置，如非本人操作请联系管理员"}', 'SMS_TEMPLATE', '重置密码成功短信模板', 5, 'JSON', '重置密码成功短信模板', NULL, 'RESET_PASSWORD_SUCCESS', 0, '{}', '2026-08-22 00:00:00', NULL, '2026-08-22 00:00:00', NULL);
INSERT INTO `sys_config` VALUES ('7812345678901234523', 'SMS_TEMPLATE_PASSWORD_EXPIRING', '{"code": "", "content": "账号 {{account}} 密码将在 {{remaining_days}} 天后过期，请尽快修改"}', 'SMS_TEMPLATE', '密码即将过期短信模板', 6, 'JSON', '密码即将过期短信模板', NULL, 'PASSWORD_EXPIRING', 0, '{}', '2026-08-22 00:00:00', NULL, '2026-08-22 00:00:00', NULL);
INSERT INTO `sys_config` VALUES ('7812345678901234524', 'SMS_TEMPLATE_CHANGE_PHONE_CODE', '{"code": "", "content": "修改手机验证码 {{code}}，{{expire_minutes}} 分钟内有效"}', 'SMS_TEMPLATE', '修改手机验证码短信模板', 22, 'JSON', '修改手机验证码短信模板', NULL, 'CHANGE_PHONE_CODE', 0, '{}', '2026-08-22 00:00:00', NULL, '2026-08-22 00:00:00', NULL);
...
CREATE TABLE `sys_workspace_shortcut` (
  ...
  `resource_id` varchar(64) NOT NULL COMMENT '快捷菜单资源ID（sys_resource）',
  `sort` int NOT NULL COMMENT '排序号（越小越靠前）',
  `created_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '创建时间',
  `created_by` varchar(64) COMMENT '创建人（账户ID）',
  `updated_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '更新时间',
...
CREATE TABLE `sys_dept` (
  `id` varchar(64) NOT NULL COMMENT '主键ID',
  `parent_id` varchar(64) COMMENT '父级ID',
  `master_id` varchar(64) COMMENT '部门主管账户ID',
  `deputy_master_id` varchar(64) COMMENT '部门副主管账户ID',
  `name` varchar(64) NOT NULL COMMENT '部门名称',
  `category` varchar(64) NOT NULL COMMENT '部门类别/层级类型',
  `sort` int NOT NULL COMMENT '排序号（越小越靠前）',
  `is_virtual` tinyint(1) NOT NULL COMMENT '是否虚拟组织：1 虚拟 / 0 实体',
  `status` varchar(32) NOT NULL COMMENT '部门状态：ENABLED/DISABLED',
  `extra` json NOT NULL COMMENT '扩展信息（JSON）',
  `created_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '创建时间',
  `created_by` varchar(64) COMMENT '创建人（账户ID）',
  `updated_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '更新时间',
...
CREATE TABLE `sys_dict` (
  ...
  `code` varchar(50) NOT NULL COMMENT '字典项编码（同父级下唯一）',
  `label` varchar(255) COMMENT '字典项展示标签',
  `value` varchar(255) COMMENT '字典项实际值',
  `color` varchar(32) COMMENT '前端展示颜色',
  `category` varchar(64) COMMENT '字典分类：SYSTEM（系统）/ BUSINESS（业务）',
  `parent_id` varchar(32) COMMENT '父级字典项ID',
  `status` varchar(16) NOT NULL COMMENT '字典项状态：ENABLED/DISABLED',
  `sort` int NOT NULL COMMENT '排序号（越小越靠前）',
  `created_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '创建时间',
  `created_by` varchar(64) COMMENT '创建人（账户ID）',
  `updated_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '更新时间',
...
INSERT INTO `sys_dict` VALUES ('100139', 'NOTIFY_LOCATION_WORKSPACE', '工作台公告区', 'workspace', '#722ed1', 'SYS', '100136', 'ENABLED', 3, '2026-07-24 00:00:00', NULL, '2026-07-24 00:00:00', NULL);
...
INSERT INTO `sys_dict` VALUES ('100220', 'AUDIT_ACTION_TYPE', '审计操作类型', 'AUDIT_ACTION_TYPE', '#2080f0', 'SYS', NULL, 'ENABLED', 0, '2026-08-22 00:00:00', NULL, '2026-08-22 00:00:00', NULL);
INSERT INTO `sys_dict` VALUES ('100221', 'AUDIT_ACTION_TYPE_CREATE', '新增', 'CREATE', '#18a058', 'SYS', '100220', 'ENABLED', 1, '2026-08-22 00:00:00', NULL, '2026-08-22 00:00:00', NULL);
INSERT INTO `sys_dict` VALUES ('100222', 'AUDIT_ACTION_TYPE_UPDATE', '修改', 'UPDATE', '#2080f0', 'SYS', '100220', 'ENABLED', 2, '2026-08-22 00:00:00', NULL, '2026-08-22 00:00:00', NULL);
INSERT INTO `sys_dict` VALUES ('100223', 'AUDIT_ACTION_TYPE_DELETE', '删除', 'DELETE', '#d03050', 'SYS', '100220', 'ENABLED', 3, '2026-08-22 00:00:00', NULL, '2026-08-22 00:00:00', NULL);
INSERT INTO `sys_dict` VALUES ('100224', 'AUDIT_ACTION_TYPE_QUERY', '查询', 'QUERY', '#909399', 'SYS', '100220', 'ENABLED', 4, '2026-08-22 00:00:00', NULL, '2026-08-22 00:00:00', NULL);
INSERT INTO `sys_dict` VALUES ('100225', 'AUDIT_ACTION_TYPE_EXPORT', '导出', 'EXPORT', '#f0a020', 'SYS', '100220', 'ENABLED', 5, '2026-08-22 00:00:00', NULL, '2026-08-22 00:00:00', NULL);
INSERT INTO `sys_dict` VALUES ('100226', 'AUDIT_ACTION_TYPE_LOGIN', '登录', 'LOGIN', '#18a058', 'SYS', '100220', 'ENABLED', 6, '2026-08-22 00:00:00', NULL, '2026-08-22 00:00:00', NULL);
INSERT INTO `sys_dict` VALUES ('100227', 'AUDIT_ACTION_TYPE_LOGOUT', '登出', 'LOGOUT', '#722ed1', 'SYS', '100220', 'ENABLED', 7, '2026-08-22 00:00:00', NULL, '2026-08-22 00:00:00', NULL);
INSERT INTO `sys_dict` VALUES ('100228', 'AUDIT_ACTION_TYPE_OTHER', '其它', 'OTHER', '#909399', 'SYS', '100220', 'ENABLED', 8, '2026-08-22 00:00:00', NULL, '2026-08-22 00:00:00', NULL);
...
CREATE TABLE `sys_feedback` (
  ...
  `status` varchar(32) NOT NULL COMMENT '反馈状态：PENDING/REPLIED/CLOSED 等',
  `reply` text COMMENT '管理员回复内容',
  `replied_by` varchar(64) COMMENT '回复人账户ID',
  `replied_at` datetime(6) COMMENT '管理员回复时间',
  `submitter_account_type` varchar(32) NOT NULL COMMENT '提交人账户类型',
  `submitter_account_id` varchar(64) NOT NULL COMMENT '提交人账户ID',
  `created_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '创建时间',
  `created_by` varchar(64) COMMENT '创建人（账户ID）',
  `updated_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '更新时间',
  `updated_by` varchar(64) COMMENT '更新人（账户ID）'
...
CREATE TABLE `sys_file` (
  `id` varchar(64) NOT NULL COMMENT '主键ID',
  `object_name` varchar(255) NOT NULL COMMENT '对象存储中的对象键/路径',
  `original_name` varchar(255) NOT NULL COMMENT '用户上传时的原始文件名',
  `storage_provider` varchar(32) NOT NULL COMMENT '存储服务商：minio/rustfs/oss/s3',
  `bucket` varchar(255) COMMENT '对象存储桶名称',
  `content_type` varchar(128) NOT NULL COMMENT 'MIME 类型',
  `size` bigint NOT NULL COMMENT '文件大小（字节）',
  `url` varchar(1024) NOT NULL COMMENT '文件访问 URL（可为签名地址）',
  `created_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '创建时间',
  `created_by` varchar(64) COMMENT '创建人（账户ID）',
  `updated_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '更新时间',
  `updated_by` varchar(64) COMMENT '更新人（账户ID）'
...
CREATE TABLE `sys_group` (
  ...
  `owner_dept_id` varchar(64) COMMENT '所属部门ID（数据权限范围）',
  `description` text COMMENT '用户组描述',
  `status` varchar(32) NOT NULL COMMENT '用户组状态：ENABLED/DISABLED',
  `extra` json NOT NULL COMMENT '扩展信息（JSON）',
  `created_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '创建时间',
  `created_by` varchar(64) COMMENT '创建人（账户ID）',
  `updated_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '更新时间',
...
CREATE TABLE `sys_iam_relation` (
  `id` varchar(64) NOT NULL COMMENT '主键ID',
  `subject_type` varchar(32) NOT NULL COMMENT '主体类型：ACCOUNT/DEPT/ROLE/GROUP/POSITION',
  `subject_id` varchar(64) NOT NULL COMMENT '主体记录ID',
  `account_type` varchar(32) NOT NULL COMMENT '账户类型：ADMIN（管理端）/ PORTAL（门户端）',
  `relation_type` varchar(64) NOT NULL COMMENT '关系类型：MEMBER/GRANT/OWN 等',
  `target_type` varchar(32) NOT NULL COMMENT '目标类型：RESOURCE/ROLE/DEPT/DATA_SCOPE 等',
  `target_id` varchar(64) NOT NULL COMMENT '目标记录ID',
  `target_key` varchar(128) NOT NULL COMMENT '目标业务标识（如权限 code）',
  `grant_mode` varchar(32) NOT NULL COMMENT '授权模式：DIRECT/INHERIT 等',
  `data_scope` varchar(32) NOT NULL COMMENT '数据范围：ALL/DEPT/DEPT_AND_CHILD/CUSTOM/SELF',
  `custom_scope_dept_ids` json NOT NULL COMMENT '自定义数据范围部门ID列表（JSON 数组）',
  `is_primary` tinyint(1) NOT NULL COMMENT '是否主关系/主岗位：1 是 / 0 否',
  `sort` int NOT NULL COMMENT '排序号（越小越靠前）',
  `status` varchar(32) NOT NULL COMMENT '关系状态：ACTIVE/INACTIVE',
  `description` text COMMENT 'IAM 关系说明',
  `reason` text COMMENT '授权/变更原因',
  `expired_at` datetime(6) COMMENT '关系失效时间（空表示永久）',
  `extra` json NOT NULL COMMENT '扩展信息（JSON）',
  `created_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '创建时间',
  `created_by` varchar(64) COMMENT '创建人（账户ID）',
  `updated_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '更新时间',
...
INSERT INTO `sys_iam_relation` VALUES ('8106481288132251001', 'RESOURCE', '202231', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'sys:realname:verify', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '审核实名认证', NULL, NULL, '{}', '2026-08-22 00:00:00', NULL, '2026-08-22 00:00:00', NULL);
-- IAM resource permission bindings (buttons/menu → permission key + data scope)
INSERT INTO `sys_iam_relation` VALUES ('8107100000000001', 'RESOURCE', '200007', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:account:page', 'CASCADE', 'CUSTOM', '["8200000000000102","8200000000000103"]', 0, 0, 'ENABLED', '账号管理访问', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000002', 'RESOURCE', '200008', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:dept:tree', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '部门管理访问', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000003', 'RESOURCE', '200009', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:group:page', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '用户组管理访问', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000004', 'RESOURCE', '200010', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:position:page', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '岗位管理访问', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000005', 'RESOURCE', '200011', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:role:page', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '角色管理访问', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000006', 'RESOURCE', '200012', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:resource:list', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '资源管理访问', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000007', 'RESOURCE', '200012', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:resource:page', 'CASCADE', 'ALL', '[]', 0, 1, 'ENABLED', '资源管理访问', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000008', 'RESOURCE', '200018', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:resourcemodule:page', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '资源模块管理访问', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000009', 'RESOURCE', '200031', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:clientmodule:page', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '客户端模块管理访问', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000010', 'RESOURCE', '200032', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:clientresource:list', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '客户端资源管理访问', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000011', 'RESOURCE', '200032', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:clientresource:page', 'CASCADE', 'ALL', '[]', 0, 1, 'ENABLED', '客户端资源管理访问', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000012', 'RESOURCE', '201101', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:account:create', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '新增账号', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000013', 'RESOURCE', '201102', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:account:detail', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '查看账号', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000014', 'RESOURCE', '201103', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:account:update', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '编辑账号', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000015', 'RESOURCE', '201104', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:account:delete', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '删除账号', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000016', 'RESOURCE', '201105', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:account:grantrole', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '分配角色', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000017', 'RESOURCE', '201106', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:account:grantgroup', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '分配用户组', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000018', 'RESOURCE', '201107', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:account:grantdept', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '分配部门', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000019', 'RESOURCE', '201108', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:account:grantresource', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '分配资源', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000020', 'RESOURCE', '201109', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:account:grantclientresource', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '分配客户端资源', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000021', 'RESOURCE', '201121', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:dept:create', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '新增部门', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000022', 'RESOURCE', '201122', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:dept:detail', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '查看部门', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000023', 'RESOURCE', '201123', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:dept:update', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '编辑部门', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000024', 'RESOURCE', '201124', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:dept:delete', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '删除部门', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000025', 'RESOURCE', '201131', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:group:create', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '新增用户组', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000026', 'RESOURCE', '201132', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:group:detail', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '查看用户组', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000027', 'RESOURCE', '201133', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:group:update', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '编辑用户组', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000028', 'RESOURCE', '201134', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:group:delete', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '删除用户组', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000029', 'RESOURCE', '201135', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:group:grantuser', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '分配用户', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000030', 'RESOURCE', '201136', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:group:grantrole', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '分配角色', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000031', 'RESOURCE', '201137', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:group:grantresource', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '分配资源', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000032', 'RESOURCE', '201138', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:group:grantclientresource', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '分配客户端资源', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000033', 'RESOURCE', '201151', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:position:create', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '新增岗位', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000034', 'RESOURCE', '201152', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:position:detail', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '查看岗位', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000035', 'RESOURCE', '201153', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:position:update', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '编辑岗位', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000036', 'RESOURCE', '201154', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:position:delete', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '删除岗位', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000037', 'RESOURCE', '201161', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:role:create', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '新增角色', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000038', 'RESOURCE', '201162', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:role:detail', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '查看角色', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000039', 'RESOURCE', '201163', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:role:update', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '编辑角色', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000040', 'RESOURCE', '201164', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:role:delete', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '删除角色', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000041', 'RESOURCE', '201165', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:role:grantresource', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '分配资源', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000042', 'RESOURCE', '201167', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:role:grantuser', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '分配用户', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000043', 'RESOURCE', '201168', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:role:grantclientresource', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '分配客户端资源', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000044', 'RESOURCE', '201181', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:resource:create', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '新增资源', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000045', 'RESOURCE', '201182', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:resource:detail', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '查看资源', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000046', 'RESOURCE', '201183', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:resource:update', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '编辑资源', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000047', 'RESOURCE', '201184', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:resource:delete', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '删除资源', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000048', 'RESOURCE', '201186', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:resource:list', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '资源树', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000049', 'RESOURCE', '201185', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:resource:grant', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '绑定权限', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000050', 'RESOURCE', '201191', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:resourcemodule:create', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '新增资源模块', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000051', 'RESOURCE', '201192', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:resourcemodule:detail', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '查看资源模块', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000052', 'RESOURCE', '201193', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:resourcemodule:update', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '编辑资源模块', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000053', 'RESOURCE', '201194', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:resourcemodule:delete', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '删除资源模块', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000054', 'RESOURCE', '201311', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:clientmodule:create', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '新增客户端模块', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000055', 'RESOURCE', '201312', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:clientmodule:detail', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '查看客户端模块', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000056', 'RESOURCE', '201313', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:clientmodule:update', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '编辑客户端模块', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000057', 'RESOURCE', '201314', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:clientmodule:delete', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '删除客户端模块', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000058', 'RESOURCE', '201321', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:clientresource:create', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '新增客户端资源', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000059', 'RESOURCE', '201322', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:clientresource:detail', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '查看客户端资源', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000060', 'RESOURCE', '201323', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:clientresource:update', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '编辑客户端资源', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000061', 'RESOURCE', '201324', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:clientresource:delete', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '删除客户端资源', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000062', 'RESOURCE', '201325', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:clientresource:list', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '客户端资源树', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107100000000063', 'RESOURCE', '201326', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'iam:clientresource:grant', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '绑定客户端资源权限', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
-- Remaining resource permission bindings (buttons/menu → permission key)
INSERT INTO `sys_iam_relation` VALUES ('8107200000000001', 'RESOURCE', '201011', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'sys:dict:create', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '新增字典', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107200000000002', 'RESOURCE', '201012', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'sys:dict:detail', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '查看字典', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107200000000003', 'RESOURCE', '201013', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'sys:dict:update', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '编辑字典', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107200000000004', 'RESOURCE', '201014', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'sys:dict:delete', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '删除字典', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107200000000005', 'RESOURCE', '201021', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'sys:banner:create', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '新增展示图', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107200000000006', 'RESOURCE', '201022', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'sys:banner:detail', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '查看展示图', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107200000000007', 'RESOURCE', '201023', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'sys:banner:update', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '编辑展示图', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107200000000008', 'RESOURCE', '201024', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'sys:banner:delete', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '删除展示图', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107200000000009', 'RESOURCE', '201031', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'sys:file:upload', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '上传文件', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107200000000010', 'RESOURCE', '201032', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'sys:file:detail', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '查看文件', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107200000000011', 'RESOURCE', '201033', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'sys:file:update', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '编辑文件', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107200000000012', 'RESOURCE', '201034', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'sys:file:url', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '打开文件', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107200000000013', 'RESOURCE', '201035', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'sys:file:delete', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '删除文件', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107200000000014', 'RESOURCE', '201041', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'auth:session:tokenlist', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '查看令牌', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107200000000015', 'RESOURCE', '201042', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'auth:session:exit', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '强退账号', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107200000000016', 'RESOURCE', '201043', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'auth:session:tokenexit', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '强退令牌', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107200000000017', 'RESOURCE', '201051', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'sys:codegen:create', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '新增生成方案', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107200000000018', 'RESOURCE', '201052', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'sys:codegen:detail', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '查看生成方案', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107200000000019', 'RESOURCE', '201053', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'sys:codegen:update', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '编辑生成方案', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107200000000020', 'RESOURCE', '201054', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'sys:codegen:delete', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '删除生成方案', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107200000000021', 'RESOURCE', '201055', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'sys:codegen:tables', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '读取数据库表', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107200000000022', 'RESOURCE', '201056', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'sys:codegen:preview', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '预览代码', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107200000000023', 'RESOURCE', '201057', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'sys:codegen:download', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '下载代码', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107200000000024', 'RESOURCE', '202011', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'sys:config:create', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '新增系统配置', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107200000000025', 'RESOURCE', '202012', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'sys:config:detail', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '查看系统配置', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107200000000026', 'RESOURCE', '202013', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'sys:config:update', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '编辑系统配置', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107200000000027', 'RESOURCE', '202251', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'sys:weakpassword:page', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '分页弱密码', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107200000000028', 'RESOURCE', '202252', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'sys:weakpassword:create', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '新增弱密码', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107200000000029', 'RESOURCE', '202253', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'sys:weakpassword:update', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '编辑弱密码', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107200000000030', 'RESOURCE', '202254', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'sys:weakpassword:delete', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '删除弱密码', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107200000000031', 'RESOURCE', '202255', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'sys:weakpassword:detail', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '查看弱密码', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107200000000032', 'RESOURCE', '202221', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'sys:feedback:page', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '分页反馈', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107200000000033', 'RESOURCE', '202222', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'sys:feedback:detail', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '查看反馈', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107200000000034', 'RESOURCE', '202223', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'sys:feedback:update', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '处理反馈', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107200000000035', 'RESOURCE', '202224', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'sys:feedback:delete', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '删除反馈', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107200000000036', 'RESOURCE', '200004', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'sys:dict:page', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '字典管理访问', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107200000000037', 'RESOURCE', '200005', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'sys:banner:page', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '展示图管理访问', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107200000000038', 'RESOURCE', '200023', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'sys:file:page', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '文件管理访问', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107200000000039', 'RESOURCE', '200025', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'auth:session:page', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '在线会话访问', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107200000000040', 'RESOURCE', '202230', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'sys:realname:verify', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '实名认证审核访问', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107200000000041', 'RESOURCE', '202015', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'sys:codegen:page', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '代码生成访问', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107200000000042', 'RESOURCE', '202010', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'sys:config:page', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '系统配置访问', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107200000000043', 'RESOURCE', '202010', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'sys:weakpassword:page', 'CASCADE', 'ALL', '[]', 0, 1, 'ENABLED', '系统配置访问', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107200000000044', 'RESOURCE', '202220', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'sys:feedback:page', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '反馈管理访问', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_iam_relation` VALUES ('8107200000000045', 'RESOURCE', '202200', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'sys:notice:page', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '通知消息访问', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
-- Remaining resource permission bindings (buttons/menu → permission key)
INSERT INTO `sys_iam_relation` VALUES ('8107200000000046', 'RESOURCE', '202014', 'ADMIN', 'RESOURCE_PERMISSION', 'PERMISSION', '', 'sys:config:delete', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '删除系统配置', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
...
CREATE TABLE `sys_job` (
  `id` varchar(64) NOT NULL COMMENT '主键ID',
  `name` varchar(128) NOT NULL COMMENT '名称',
  `handler` varchar(255) NOT NULL COMMENT '任务处理器标识（Boot 为 JobHandler 全限定类名）',
  `trigger_type` varchar(16) NOT NULL COMMENT '触发类型：CRON（表达式）/ FIXED（固定间隔秒）',
  `trigger_config` varchar(255) NOT NULL COMMENT '触发配置：Cron 表达式或间隔秒数',
  `params` json COMMENT '执行参数（JSON）',
  `last_run_time` datetime(6) COMMENT '上次调度执行时间',
  `next_run_time` datetime(6) NOT NULL COMMENT '下次计划执行时间',
  `last_result` varchar(500) COMMENT '上次执行结果摘要',
...
-- Records of sys_job
-- ----------------------------
INSERT INTO `sys_job` VALUES ('7541000000000000006', '注销账号清理', 'github.jiangbyte.io.iam.modules.account.job.AccountPurgeCancelledJob', 'CRON', '0 0 3 * * *', '{"retentionDays": 15}', '2026-08-16 09:53:27.108262', '2026-08-16 19:00:00', 'purged=0', 0, '每日清理已取消且超过保留期的账号数据', 6, '2026-08-16 09:53:26.897926', NULL, '2026-08-16 09:53:27.152576', NULL);
INSERT INTO `sys_job` VALUES ('7541000000000000007', '审计日志清理', 'github.jiangbyte.io.sys.modules.audit.job.AuditLogCleanupJob', 'CRON', '0 0 4 * * *', '{"loginRetentionDays": 180, "operationRetentionDays": 365, "batchSize": 1000}', '2026-08-16 09:53:27.108262', '2026-08-16 19:00:00', 'deletedLogin=0,deletedOperation=0', 0, '每日按保留天数清理过期登录与操作审计日志', 7, '2026-08-16 09:53:26.897926', NULL, '2026-08-16 09:53:27.152576', NULL);
INSERT INTO `sys_job` VALUES ('7541000000000000008', '任务执行日志清理', 'github.jiangbyte.io.sys.modules.job.cleanup.SysJobLogCleanupJob', 'CRON', '0 30 3 * * *', '{"retentionDays": 30, "batchSize": 1000}', '2026-08-16 09:53:27.104743', '2026-08-16 19:30:00', 'deleted=0,retentionDays=30,batchSize=1000', 0, '按保留天数批量清理过期 sys_job_log', 8, '2026-08-16 09:53:26.903237', NULL, '2026-08-16 09:53:27.146058', NULL);
INSERT INTO `sys_job` VALUES ('7541000000000000004', '审计告警', 'github.jiangbyte.io.sys.modules.audit.job.AuditAlertJob', 'FIXED', '300', '{}', '2026-08-16 10:25:56.244268', '2026-08-16 10:30:56.283976', 'done fired=0', 0, '按配置规则扫描审计日志并发送告警', 4, '2026-08-16 09:53:26.892521', NULL, '2026-08-16 10:25:56.289499', NULL);
INSERT INTO `sys_job` VALUES ('7541000000000000001', '示例任务', 'github.jiangbyte.io.sys.modules.job.sample.SysJobSample', 'FIXED', '60', '{}', '2026-08-16 10:27:57.95913', '2026-08-16 10:28:57.960251', 'echo: (无参数)', 0, '演示调度链路：回显执行参数', 1, '2026-08-16 09:53:26.876522', NULL, '2026-08-16 10:27:57.960251', NULL);
INSERT INTO `sys_job` VALUES ('7541000000000000003', 'Banner 互动计数刷库', 'github.jiangbyte.io.sys.modules.banner.job.BannerFlushInteractionsJob', 'FIXED', '60', '{}', '2026-08-16 10:27:57.95913', '2026-08-16 10:28:57.962143', 'flushed=0', 0, '将 Redis 互动增量写入 sys_banner.interaction_count', 3, '2026-08-16 09:53:26.887732', NULL, '2026-08-16 10:27:57.963134', NULL);
INSERT INTO `sys_job` VALUES ('7541000000000000002', 'Banner 状态同步', 'github.jiangbyte.io.sys.modules.banner.job.BannerStatusJob', 'FIXED', '60', '{}', '2026-08-16 10:27:57.95913', '2026-08-16 10:28:57.970142', 'expired=0,activated=0', 0, '按 start_at / end_at 激活或过期 Banner', 2, '2026-08-16 09:53:26.882777', NULL, '2026-08-16 10:27:57.970142', NULL);
...
CREATE TABLE `sys_job_log` (
  `id` varchar(64) NOT NULL COMMENT '主键ID',
  `job_id` varchar(64) NOT NULL COMMENT '关联任务定义ID（sys_job.id）',
  `params` json COMMENT '执行参数快照（JSON）',
  `started_at` datetime(6) NOT NULL COMMENT '本次执行开始时间',
  `duration_ms` bigint COMMENT '执行用时（毫秒）',
  `success` tinyint(1) NOT NULL COMMENT '执行结果：是否成功',
  `result` text COMMENT '执行结果摘要或错误堆栈摘要',
  `executor` varchar(64) COMMENT '执行人：人工触发为账户ID，调度为 system',
  `ip` varchar(64) COMMENT '客户端/实例 IP 地址',
  `process_id` varchar(32) COMMENT '执行进程 PID',
  `app_dir` varchar(500) COMMENT '执行实例应用目录',
  `created_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '创建时间',
  `created_by` varchar(64) COMMENT '创建人（账户ID）',
  `updated_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '更新时间',
  `updated_by` varchar(64) COMMENT '更新人（账户ID）'
...
CREATE TABLE `sys_notice` (
  `id` varchar(64) NOT NULL COMMENT '主键ID',
  `kind` varchar(32) NOT NULL COMMENT '消息种类：NOTIFICATION（通知）/ ANNOUNCEMENT（公告）',
  `title` varchar(255) NOT NULL COMMENT '标题',
  `content` text NOT NULL COMMENT '内容',
  `content_type` varchar(32) NOT NULL COMMENT '内容格式：TEXT/HTML/MARKDOWN 等',
  `category` varchar(32) COMMENT '通知分类编码',
  `severity` varchar(32) NOT NULL COMMENT '重要等级：INFO/WARNING/ERROR 等',
  `target_scope` varchar(32) NOT NULL COMMENT '投放范围：ALL/ACCOUNT/DEPT/ROLE 等',
  ...
  `pinned_until` datetime(6) COMMENT '置顶截止时间',
  `sender_account_type` varchar(32) COMMENT '发送方账户类型',
  `sender_account_id` varchar(64) COMMENT '发送方账户ID',
  `source_type` varchar(64) COMMENT '来源业务模块标识',
  `source_id` varchar(64) COMMENT '来源业务记录ID',
  `status` varchar(32) NOT NULL COMMENT '发布状态：DRAFT/PUBLISHED/REVOKED 等',
  `publish_at` datetime(6) COMMENT '计划/实际发布时间',
  `revoked_at` datetime(6) COMMENT '撤回时间',
  `expire_at` datetime(6) COMMENT '过期时间（公告有效截止）',
  `view_count` int NOT NULL COMMENT '浏览/查看次数',
  `extra` json NOT NULL COMMENT '扩展信息（JSON）',
  `created_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '创建时间',
  `created_by` varchar(64) COMMENT '创建人（账户ID）',
...
INSERT INTO `sys_notice` VALUES ('7491853809015291905', 'ANNOUNCEMENT', '系统维护预告', '本周日 02:00-04:00 将进行例行维护，期间门户可能短暂不可用，请提前做好安排。', 'markdown', 'SYSTEM', 'WARNING', 'ALL', '["PORTAL", "ADMIN"]', '[]', '[]', '[]', '{"center": true, "popup": true, "workspace": true}', 0, NULL, NULL, NULL, NULL, NULL, 'PUBLISHED', '2026-08-08 12:52:19.890496', NULL, '2026-08-22 13:52:19.890496', 1, '{}', '2026-08-08 13:52:19.983927', NULL, '2026-08-08 14:11:23.438139', NULL);
...
CREATE TABLE `sys_notice_read` (
  `id` varchar(64) NOT NULL COMMENT '主键ID',
  `notice_id` varchar(64) NOT NULL COMMENT '公告/通知ID（sys_notice.id）',
  `account_type` varchar(32) NOT NULL COMMENT '账户类型：ADMIN（管理端）/ PORTAL（门户端）',
  `account_id` varchar(64) NOT NULL COMMENT '账户ID',
...
CREATE TABLE `sys_operation_audit_log` (
  `id` varchar(64) NOT NULL COMMENT '主键ID',
  `module` varchar(64) NOT NULL COMMENT '业务模块编码（如 sys、iam）',
  `resource_type` varchar(128) COMMENT '资源类型编码（如 SysAccount）',
  `resource_id` varchar(128) COMMENT '被操作资源主键ID',
  `action` varchar(64) NOT NULL COMMENT '操作动作编码',
  `summary` varchar(2000) COMMENT '操作内容可读摘要',
  `before_data` json COMMENT '变更前数据（JSON）',
  `after_data` json COMMENT '变更后数据（JSON）',
  `account_id` varchar(64) COMMENT '操作人账户ID',
  `account_type` varchar(32) COMMENT '操作人账户类型：ADMIN/PORTAL',
  `request_id` varchar(64) COMMENT '请求链路 ID（Trace）',
  `ip` varchar(64) COMMENT '客户端/实例 IP 地址',
  `user_agent` varchar(512) COMMENT '客户端 User-Agent',
  `success` tinyint(1) NOT NULL COMMENT '是否成功：1 成功 / 0 失败',
  `error_message` text COMMENT '错误信息',
  `operator_name` varchar(128) COMMENT '操作人昵称快照（写入时落库）',
  `action_name` varchar(128) COMMENT '操作名称（前端展示）',
  `action_type` varchar(32) COMMENT '操作类型：CREATE/UPDATE/DELETE/QUERY/EXPORT/LOGIN/LOGOUT/OTHER',
  `module_label` varchar(128) COMMENT '操作模块中文展示名',
...
INSERT INTO `sys_operation_audit_log` VALUES ('7491856220572278784', 'iam', 'read-all', NULL, 'post', 'POST /api/v1/admin/sys/notices/read-all', 'null', 'null', '1', 'ADMIN', 'e8b49b5611db4c498bb8fcb2f0ddfe12', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36', 0, NULL, NULL, NULL, NULL, NULL, NULL, '2026-08-08 14:01:54.9441');
...
INSERT INTO `sys_operation_audit_log` VALUES ('7491869125392965632', 'iam', 'batch-save', NULL, 'post', 'POST /api/v1/admin/sys/config/batch-save', 'null', 'null', '1', 'ADMIN', 'bfad8619bcb04e929dbe3b8f4ceeb34b', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36', 0, NULL, NULL, NULL, NULL, NULL, NULL, '2026-08-08 14:53:11.69228');
...
INSERT INTO `sys_operation_audit_log` VALUES ('7491869288723357696', 'iam', 'batch-save', NULL, 'post', 'POST /api/v1/admin/sys/config/batch-save', 'null', 'null', '1', 'ADMIN', '94a81d39bd6d4179b431c24ba933c36b', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36', 0, NULL, NULL, NULL, NULL, NULL, NULL, '2026-08-08 14:53:50.63331');
...
INSERT INTO `sys_operation_audit_log` VALUES ('7491869580353314816', 'auth', 'account', '7491847383584804864', 'login', 'PORTAL login succeeded', 'null', 'null', '7491847383584804864', 'PORTAL', 'ed81b9adb9254c798c5389e9304fae3e', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36', 0, NULL, NULL, NULL, NULL, NULL, NULL, '2026-08-08 14:54:59.8293');
...
INSERT INTO `sys_operation_audit_log` VALUES ('7491871872095834112', 'iam', 'logout', NULL, 'post', 'POST /api/v1/portal/logout', 'null', 'null', '7491847383584804864', 'PORTAL', 'ae74d9a084604aa28c8f3c54af94de95', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36', 0, NULL, NULL, NULL, NULL, NULL, NULL, '2026-08-08 15:04:06.55724');
...
INSERT INTO `sys_operation_audit_log` VALUES ('7491906012094656512', 'iam', 'upload', NULL, 'post', 'POST /api/v1/admin/sys/file/upload', 'null', 'null', '1', 'ADMIN', 'ad21a931262a45928ee617d6a1425ece', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36', 0, NULL, NULL, NULL, NULL, NULL, NULL, '2026-08-08 17:19:46.1667');
...
INSERT INTO `sys_operation_audit_log` VALUES ('7491984343368400896', 'auth', 'account', '1', 'login', 'ADMIN login succeeded', 'null', 'null', '1', 'ADMIN', '565285e8a92d4db183eb55f22bf5ebd5', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36', 0, NULL, NULL, NULL, NULL, NULL, NULL, '2026-08-08 22:31:01.16333');
...
INSERT INTO `sys_operation_audit_log` VALUES ('7491985465474744320', 'auth', 'account', '7491847383584804864', 'login', 'PORTAL login succeeded', 'null', 'null', '7491847383584804864', 'PORTAL', 'b2cf5db7a39c42d792ee141212e7892e', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36', 0, NULL, NULL, NULL, NULL, NULL, NULL, '2026-08-08 22:35:29.00935');
...
CREATE TABLE `sys_operation_audit_outbox` (
  ...
  `status` varchar(32) NOT NULL COMMENT '投递状态：PENDING/CLAIMED/DONE/DEAD',
  `attempts` int NOT NULL COMMENT '重试次数',
  `created_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '创建时间',
  `claimed_at` datetime(6) COMMENT '消费者认领时间'
) COMMENT='操作审计 Outbox';
-- ----------------------------
...
CREATE TABLE `sys_position` (
  ...
  `sort` int NOT NULL COMMENT '排序号（越小越靠前）',
  `is_virtual` tinyint(1) NOT NULL COMMENT '是否虚拟组织：1 虚拟 / 0 实体',
  `status` varchar(32) NOT NULL COMMENT '职位状态：ENABLED/DISABLED',
...
CREATE TABLE `sys_resource` (
  `id` varchar(64) NOT NULL COMMENT '主键ID',
  `parent_id` varchar(64) COMMENT '父级资源ID（菜单树）',
  `code` varchar(64) NOT NULL COMMENT '编码',
  `name` varchar(64) NOT NULL COMMENT '名称',
  `resource_type` varchar(32) NOT NULL COMMENT '资源类型：MENU/BUTTON/API 等',
  `module_id` varchar(64) COMMENT '所属资源模块ID',
  `path` varchar(255) COMMENT '路径',
  `component` varchar(255) COMMENT '前端路由组件路径',
  `redirect` varchar(255) COMMENT '路由重定向地址',
  `icon` varchar(255) COMMENT '图标标识',
  `color` varchar(32) COMMENT '颜色值',
  `href` varchar(255) COMMENT '外链地址',
  `sort` int NOT NULL COMMENT '排序号（越小越靠前）',
  `is_visible` tinyint(1) NOT NULL COMMENT '是否可见：1 可见 / 0 隐藏',
  `is_cache` tinyint(1) NOT NULL COMMENT '是否缓存路由：1 缓存 / 0 不缓存',
  `is_affix` tinyint(1) NOT NULL COMMENT '是否固定标签页：1 固定 / 0 不固定',
  `status` varchar(32) NOT NULL COMMENT '资源状态：ENABLED/DISABLED',
  `description` text COMMENT '资源描述说明',
  `layout` varchar(255) COMMENT '页面布局类型',
  `extra` json NOT NULL COMMENT '扩展信息（JSON）',
  `created_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '创建时间',
  `created_by` varchar(64) COMMENT '创建人（账户ID）',
  `updated_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '更新时间',
  `updated_by` varchar(64) COMMENT '更新人（账户ID）'
) COMMENT='菜单/按钮/API 资源';
-- ----------------------------
-- Records of sys_resource
-- ----------------------------
INSERT INTO `sys_resource` VALUES ('200001', NULL, 'workspace', '工作台', 'MENU', '210001', '/workspace', '/workspace/index.vue', NULL, 'icon-park-outline:analysis', NULL, NULL, 1, 1, 0, 0, 'ENABLED', NULL, NULL, '{}', '2026-06-30 00:00:00', NULL, '2026-06-30 00:00:00', NULL);
INSERT INTO `sys_resource` VALUES ('200002', '200001', 'workspace-overview', '查看工作台总览', 'BUTTON', '210001', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, 0, 0, 'ENABLED', NULL, NULL, '{}', '2026-06-30 00:00:00', NULL, '2026-06-30 00:00:00', NULL);
...
INSERT INTO `sys_resource` VALUES ('201186', '200012', 'iam-resource-list', '资源树', 'BUTTON', '210001', NULL, NULL, NULL, NULL, NULL, NULL, 6, 0, 0, 0, 'ENABLED', NULL, NULL, '{}', '2026-07-03 00:00:00', NULL, '2026-07-03 00:00:00', NULL);
...
INSERT INTO `sys_resource` VALUES ('202251', '202010', 'sys-weakpassword-page', '分页弱密码', 'BUTTON', '210001', NULL, NULL, NULL, NULL, NULL, NULL, 10, 0, 0, 0, 'ENABLED', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_resource` VALUES ('202252', '202010', 'sys-weakpassword-create', '新增弱密码', 'BUTTON', '210001', NULL, NULL, NULL, NULL, NULL, NULL, 11, 0, 0, 0, 'ENABLED', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_resource` VALUES ('202253', '202010', 'sys-weakpassword-update', '编辑弱密码', 'BUTTON', '210001', NULL, NULL, NULL, NULL, NULL, NULL, 12, 0, 0, 0, 'ENABLED', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_resource` VALUES ('202254', '202010', 'sys-weakpassword-delete', '删除弱密码', 'BUTTON', '210001', NULL, NULL, NULL, NULL, NULL, NULL, 13, 0, 0, 0, 'ENABLED', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
INSERT INTO `sys_resource` VALUES ('202255', '202010', 'sys-weakpassword-detail', '查看弱密码', 'BUTTON', '210001', NULL, NULL, NULL, NULL, NULL, NULL, 14, 0, 0, 0, 'ENABLED', NULL, NULL, '{}', '2026-08-23 00:00:00', NULL, '2026-08-23 00:00:00', NULL);
...
CREATE TABLE `sys_resource_module` (
  ...
  `name` varchar(64) NOT NULL COMMENT '名称',
  `code` varchar(64) NOT NULL COMMENT '编码',
  `client` varchar(32) NOT NULL COMMENT '所属客户端：admin/portal 等',
  `icon` varchar(255) COMMENT '图标标识',
  `color` varchar(32) COMMENT '颜色值',
  `sort` int NOT NULL COMMENT '排序号（越小越靠前）',
  `status` varchar(32) NOT NULL COMMENT '模块状态：ENABLED/DISABLED',
  `description` text COMMENT '资源模块描述',
  `extra` json NOT NULL COMMENT '扩展信息（JSON）',
  `created_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '创建时间',
  `created_by` varchar(64) COMMENT '创建人（账户ID）',
  `updated_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '更新时间',
...
CREATE TABLE `sys_role` (
  ...
  `code` varchar(64) NOT NULL COMMENT '编码',
  `name` varchar(64) NOT NULL COMMENT '名称',
  `category` varchar(64) NOT NULL COMMENT '角色分类',
  `scope_type` varchar(32) NOT NULL COMMENT '角色作用域：GLOBAL/DEPT 等',
  `owner_dept_id` varchar(64) COMMENT '所属部门ID（数据权限范围）',
  `sort` int NOT NULL COMMENT '排序号（越小越靠前）',
  `status` varchar(32) NOT NULL COMMENT '角色状态：ENABLED/DISABLED',
...
CREATE TABLE `sys_weak_password` (
  `id` varchar(64) NOT NULL COMMENT '主键ID',
  `password` varchar(255) NOT NULL COMMENT '弱口令明文（用于注册/改密校验）',
  `created_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '创建时间',
  `created_by` varchar(64) COMMENT '创建人（账户ID）',
  `updated_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '更新时间',
  `updated_by` varchar(64) COMMENT '更新人（账户ID）'
...
CREATE INDEX `idx_oauth_binding_union` ON `sys_account_oauth_binding` (
  `union_id`
);
...
-- authoritative column comments

SET FOREIGN_KEY_CHECKS = 1;

-- === AUTH_DEMO_SEED (auto, do not edit) ===

-- 部门树
INSERT INTO `sys_dept` VALUES ('8200000000000101', NULL, NULL, NULL, '总部', 'ORG', 1, 0, 'ENABLED', '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_dept` VALUES ('8200000000000102', '8200000000000101', '8200000000000201', '8200000000000205', '研发部', 'ORG', 1, 0, 'ENABLED', '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_dept` VALUES ('8200000000000103', '8200000000000101', '8200000000000202', NULL, '市场部', 'ORG', 2, 0, 'ENABLED', '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_dept` VALUES ('8200000000000107', '8200000000000101', '8200000000000206', NULL, '人事行政部', 'ORG', 3, 0, 'ENABLED', '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_dept` VALUES ('8200000000000104', '8200000000000102', '8200000000000203', NULL, '前端组', 'ORG', 1, 0, 'ENABLED', '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_dept` VALUES ('8200000000000105', '8200000000000102', '8200000000000208', NULL, '后端组', 'ORG', 2, 0, 'ENABLED', '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_dept` VALUES ('8200000000000106', '8200000000000102', '8200000000000209', NULL, '测试组', 'ORG', 3, 0, 'ENABLED', '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');

-- 岗位
INSERT INTO `sys_position` VALUES ('8200000000000801', '研发总监', 'MANAGEMENT', '8200000000000102', 1, 0, 'ENABLED', '研发部管理岗', '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_position` VALUES ('8200000000000802', '高级工程师', 'TECHNICAL', '8200000000000102', 2, 0, 'ENABLED', '研发部技术骨干', '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_position` VALUES ('8200000000000803', '前端工程师', 'TECHNICAL', '8200000000000104', 1, 0, 'ENABLED', '前端组默认岗位', '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_position` VALUES ('8200000000000804', '后端工程师', 'TECHNICAL', '8200000000000105', 1, 0, 'ENABLED', '后端组默认岗位', '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_position` VALUES ('8200000000000805', '测试工程师', 'TECHNICAL', '8200000000000106', 1, 0, 'ENABLED', '测试组默认岗位', '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_position` VALUES ('8200000000000806', '市场经理', 'MANAGEMENT', '8200000000000103', 1, 0, 'ENABLED', '市场部管理岗', '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_position` VALUES ('8200000000000807', '销售专员', 'OPERATION', '8200000000000103', 2, 0, 'ENABLED', '市场部业务岗', '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_position` VALUES ('8200000000000808', '人事专员', 'SUPPORT', '8200000000000107', 1, 0, 'ENABLED', '人事行政支持岗', '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');

-- 角色（非超管）
INSERT INTO `sys_role` VALUES ('2', 'IAM_ADMIN', 'IAM 管理员', 'SYS', 'PLATFORM', '8200000000000102', 10, 'ENABLED', 0, '组织权限管理（非超管）', '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_role` VALUES ('3', 'BIZ_ALL', '业务-全部数据', 'SYS', 'PLATFORM', '8200000000000103', 20, 'ENABLED', 0, '活动模块 ALL', '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_role` VALUES ('4', 'BIZ_DEPT', '业务-本部门', 'SYS', 'PLATFORM', '8200000000000102', 21, 'ENABLED', 0, '目录模块 DEPT', '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_role` VALUES ('5', 'BIZ_SELF', '业务-仅本人', 'SYS', 'PLATFORM', '8200000000000104', 22, 'ENABLED', 0, '订单模块 SELF', '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_role` VALUES ('6', 'BIZ_CHILD', '业务-部门及子部门', 'SYS', 'PLATFORM', '8200000000000102', 23, 'ENABLED', 0, '知识分类 DEPT_AND_CHILD', '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_role` VALUES ('7', 'IAM_READONLY', 'IAM 只读', 'SYS', 'PLATFORM', '8200000000000107', 30, 'ENABLED', 0, '账号管理只读', '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');

-- 用户组
INSERT INTO `sys_group` VALUES ('8200000000000301', '研发组成员', '8200000000000102', '继承 BIZ_DEPT，目录模块本部门数据', 'ENABLED', '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_group` VALUES ('8200000000000304', '前端专项组', '8200000000000104', '前端组成员，用于子部门协作演示', 'ENABLED', '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_group` VALUES ('8200000000000302', '市场运营组', '8200000000000103', '继承 BIZ_ALL，活动模块全量数据', 'ENABLED', '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_group` VALUES ('8200000000000303', 'IAM协作组', '8200000000000102', '继承 IAM_READONLY，账号只读协作', 'ENABLED', '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_group` VALUES ('8200000000000305', '后端专项组', '8200000000000105', '后端组成员，目录模块本部门数据', 'ENABLED', '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_group` VALUES ('8200000000000306', '测试专项组', '8200000000000106', '测试组成员，知识分类部门及子部门', 'ENABLED', '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');

-- 用户组-角色
INSERT INTO `sys_iam_relation` VALUES ('8200000000000311', 'GROUP', '8200000000000301', 'ADMIN', 'GROUP_ROLE', 'ROLE', '4', '', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '研发组绑定业务-本部门角色', NULL, NULL, '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_iam_relation` VALUES ('8200000000000312', 'GROUP', '8200000000000304', 'ADMIN', 'GROUP_ROLE', 'ROLE', '5', '', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '前端组绑定业务-仅本人角色', NULL, NULL, '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_iam_relation` VALUES ('8200000000000313', 'GROUP', '8200000000000302', 'ADMIN', 'GROUP_ROLE', 'ROLE', '3', '', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '市场组绑定业务-全量角色', NULL, NULL, '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_iam_relation` VALUES ('8200000000000314', 'GROUP', '8200000000000303', 'ADMIN', 'GROUP_ROLE', 'ROLE', '7', '', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', 'IAM协作组绑定只读角色', NULL, NULL, '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_iam_relation` VALUES ('8200000000000315', 'GROUP', '8200000000000305', 'ADMIN', 'GROUP_ROLE', 'ROLE', '4', '', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '后端组绑定业务-本部门角色', NULL, NULL, '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_iam_relation` VALUES ('8200000000000316', 'GROUP', '8200000000000306', 'ADMIN', 'GROUP_ROLE', 'ROLE', '6', '', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '测试组绑定业务-部门及子部门角色', NULL, NULL, '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');

-- 管理端账户
INSERT INTO `sys_account` VALUES ('8200000000000201', '$2b$12$LLjMHXpuX5MuFwevZiU11OP4OQYVIDUKBBqNeK6VvDqfTWeqs8BJi', 'ADMIN', 'ENABLED', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_account_identity` VALUES ('820000000000020101', '8200000000000201', 'ACCOUNT', 'admin_iam', 1, 1, 'BOUND', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_account_identity` VALUES ('820000000000020102', '8200000000000201', 'EMAIL', 'iam-admin@demo.local', 1, 0, 'BOUND', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `profile_user_admin` VALUES ('8200000000000201', 'IAM管理员', NULL, NULL, NULL, 'iam-admin@demo.local', 'IAM 管理员', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_account` VALUES ('8200000000000202', '$2b$12$LLjMHXpuX5MuFwevZiU11OP4OQYVIDUKBBqNeK6VvDqfTWeqs8BJi', 'ADMIN', 'ENABLED', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_account_identity` VALUES ('820000000000020201', '8200000000000202', 'ACCOUNT', 'admin_all', 1, 1, 'BOUND', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_account_identity` VALUES ('820000000000020202', '8200000000000202', 'EMAIL', 'biz-all@demo.local', 1, 0, 'BOUND', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `profile_user_admin` VALUES ('8200000000000202', '业务全量', NULL, NULL, NULL, 'biz-all@demo.local', '活动 ALL', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_account` VALUES ('8200000000000203', '$2b$12$LLjMHXpuX5MuFwevZiU11OP4OQYVIDUKBBqNeK6VvDqfTWeqs8BJi', 'ADMIN', 'ENABLED', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_account_identity` VALUES ('820000000000020301', '8200000000000203', 'ACCOUNT', 'admin_dept', 1, 1, 'BOUND', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_account_identity` VALUES ('820000000000020302', '8200000000000203', 'EMAIL', 'biz-dept@demo.local', 1, 0, 'BOUND', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `profile_user_admin` VALUES ('8200000000000203', '研发部员', NULL, NULL, NULL, 'biz-dept@demo.local', '目录 DEPT', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_account` VALUES ('8200000000000204', '$2b$12$LLjMHXpuX5MuFwevZiU11OP4OQYVIDUKBBqNeK6VvDqfTWeqs8BJi', 'ADMIN', 'ENABLED', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_account_identity` VALUES ('820000000000020401', '8200000000000204', 'ACCOUNT', 'admin_self', 1, 1, 'BOUND', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_account_identity` VALUES ('820000000000020402', '8200000000000204', 'EMAIL', 'biz-self@demo.local', 1, 0, 'BOUND', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `profile_user_admin` VALUES ('8200000000000204', '仅本人', NULL, NULL, NULL, 'biz-self@demo.local', '订单 SELF', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_account` VALUES ('8200000000000205', '$2b$12$LLjMHXpuX5MuFwevZiU11OP4OQYVIDUKBBqNeK6VvDqfTWeqs8BJi', 'ADMIN', 'ENABLED', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_account_identity` VALUES ('820000000000020501', '8200000000000205', 'ACCOUNT', 'admin_child', 1, 1, 'BOUND', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_account_identity` VALUES ('820000000000020502', '8200000000000205', 'EMAIL', 'biz-child@demo.local', 1, 0, 'BOUND', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `profile_user_admin` VALUES ('8200000000000205', '研发含子部门', NULL, NULL, NULL, 'biz-child@demo.local', '知识分类 DEPT_AND_CHILD', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_account` VALUES ('8200000000000206', '$2b$12$LLjMHXpuX5MuFwevZiU11OP4OQYVIDUKBBqNeK6VvDqfTWeqs8BJi', 'ADMIN', 'ENABLED', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_account_identity` VALUES ('820000000000020601', '8200000000000206', 'ACCOUNT', 'admin_readonly', 1, 1, 'BOUND', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_account_identity` VALUES ('820000000000020602', '8200000000000206', 'EMAIL', 'readonly@demo.local', 1, 0, 'BOUND', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `profile_user_admin` VALUES ('8200000000000206', '只读账号', NULL, NULL, NULL, 'readonly@demo.local', '账号只读', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_account` VALUES ('8200000000000207', '$2b$12$LLjMHXpuX5MuFwevZiU11OP4OQYVIDUKBBqNeK6VvDqfTWeqs8BJi', 'ADMIN', 'ENABLED', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_account_identity` VALUES ('820000000000020701', '8200000000000207', 'ACCOUNT', 'admin_group', 1, 1, 'BOUND', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_account_identity` VALUES ('820000000000020702', '8200000000000207', 'EMAIL', 'group-rd@demo.local', 1, 0, 'BOUND', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `profile_user_admin` VALUES ('8200000000000207', '组授权', NULL, NULL, NULL, 'group-rd@demo.local', '用户组继承角色', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_account` VALUES ('8200000000000208', '$2b$12$LLjMHXpuX5MuFwevZiU11OP4OQYVIDUKBBqNeK6VvDqfTWeqs8BJi', 'ADMIN', 'ENABLED', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_account_identity` VALUES ('820000000000020801', '8200000000000208', 'ACCOUNT', 'admin_be', 1, 1, 'BOUND', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_account_identity` VALUES ('820000000000020802', '8200000000000208', 'EMAIL', 'biz-be@demo.local', 1, 0, 'BOUND', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `profile_user_admin` VALUES ('8200000000000208', '后端工程师', NULL, NULL, NULL, 'biz-be@demo.local', '后端组，目录 DEPT', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_account` VALUES ('8200000000000209', '$2b$12$LLjMHXpuX5MuFwevZiU11OP4OQYVIDUKBBqNeK6VvDqfTWeqs8BJi', 'ADMIN', 'ENABLED', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_account_identity` VALUES ('820000000000020901', '8200000000000209', 'ACCOUNT', 'admin_qa', 1, 1, 'BOUND', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_account_identity` VALUES ('820000000000020902', '8200000000000209', 'EMAIL', 'biz-qa@demo.local', 1, 0, 'BOUND', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `profile_user_admin` VALUES ('8200000000000209', '测试工程师', NULL, NULL, NULL, 'biz-qa@demo.local', '测试组，知识 DEPT_AND_CHILD', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');

-- 门户账户
INSERT INTO `sys_account` VALUES ('8200000000000211', '$2b$12$LLjMHXpuX5MuFwevZiU11OP4OQYVIDUKBBqNeK6VvDqfTWeqs8BJi', 'PORTAL', 'ENABLED', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_account_identity` VALUES ('820000000000021101', '8200000000000211', 'ACCOUNT', 'portal_bob', 1, 1, 'BOUND', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_account_identity` VALUES ('820000000000021102', '8200000000000211', 'EMAIL', 'bob@demo.local', 1, 0, 'BOUND', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `profile_user_portal` VALUES ('8200000000000211', 'Bob', NULL, NULL, '13800001001', 'bob@demo.local', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_account` VALUES ('8200000000000212', '$2b$12$LLjMHXpuX5MuFwevZiU11OP4OQYVIDUKBBqNeK6VvDqfTWeqs8BJi', 'PORTAL', 'ENABLED', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_account_identity` VALUES ('820000000000021201', '8200000000000212', 'ACCOUNT', 'portal_alice', 1, 1, 'BOUND', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_account_identity` VALUES ('820000000000021202', '8200000000000212', 'EMAIL', 'alice@demo.local', 1, 0, 'BOUND', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `profile_user_portal` VALUES ('8200000000000212', 'Alice', NULL, NULL, '13800001002', 'alice@demo.local', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
-- 账户-部门
INSERT INTO `sys_iam_relation` VALUES ('8200000000000401', 'ACCOUNT', '8200000000000201', 'ADMIN', 'ACCOUNT_DEPT', 'DEPT', '8200000000000102', '', 'CASCADE', 'ALL', '[]', 1, 0, 'ENABLED', '', NULL, NULL, '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_iam_relation` VALUES ('8200000000000402', 'ACCOUNT', '8200000000000203', 'ADMIN', 'ACCOUNT_DEPT', 'DEPT', '8200000000000104', '', 'CASCADE', 'ALL', '[]', 1, 0, 'ENABLED', '', NULL, NULL, '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_iam_relation` VALUES ('8200000000000403', 'ACCOUNT', '8200000000000205', 'ADMIN', 'ACCOUNT_DEPT', 'DEPT', '8200000000000102', '', 'CASCADE', 'ALL', '[]', 1, 0, 'ENABLED', '', NULL, NULL, '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_iam_relation` VALUES ('8200000000000404', 'ACCOUNT', '8200000000000207', 'ADMIN', 'ACCOUNT_DEPT', 'DEPT', '8200000000000102', '', 'CASCADE', 'ALL', '[]', 1, 0, 'ENABLED', '', NULL, NULL, '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_iam_relation` VALUES ('8200000000000405', 'ACCOUNT', '8200000000000202', 'ADMIN', 'ACCOUNT_DEPT', 'DEPT', '8200000000000103', '', 'CASCADE', 'ALL', '[]', 1, 0, 'ENABLED', '', NULL, NULL, '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_iam_relation` VALUES ('8200000000000406', 'ACCOUNT', '8200000000000204', 'ADMIN', 'ACCOUNT_DEPT', 'DEPT', '8200000000000104', '', 'CASCADE', 'ALL', '[]', 1, 0, 'ENABLED', '', NULL, NULL, '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_iam_relation` VALUES ('8200000000000407', 'ACCOUNT', '8200000000000206', 'ADMIN', 'ACCOUNT_DEPT', 'DEPT', '8200000000000107', '', 'CASCADE', 'ALL', '[]', 1, 0, 'ENABLED', '', NULL, NULL, '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_iam_relation` VALUES ('8200000000000408', 'ACCOUNT', '8200000000000208', 'ADMIN', 'ACCOUNT_DEPT', 'DEPT', '8200000000000105', '', 'CASCADE', 'ALL', '[]', 1, 0, 'ENABLED', '', NULL, NULL, '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_iam_relation` VALUES ('8200000000000409', 'ACCOUNT', '8200000000000209', 'ADMIN', 'ACCOUNT_DEPT', 'DEPT', '8200000000000106', '', 'CASCADE', 'ALL', '[]', 1, 0, 'ENABLED', '', NULL, NULL, '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_iam_relation` VALUES ('8200000000000410', 'ACCOUNT', '8200000000000203', 'ADMIN', 'ACCOUNT_DEPT', 'DEPT', '8200000000000102', '', 'CASCADE', 'ALL', '[]', 0, 1, 'ENABLED', '前端组员工兼属研发部', NULL, NULL, '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_iam_relation` VALUES ('8200000000000411', 'ACCOUNT', '8200000000000208', 'ADMIN', 'ACCOUNT_DEPT', 'DEPT', '8200000000000102', '', 'CASCADE', 'ALL', '[]', 0, 1, 'ENABLED', '后端组员工兼属研发部', NULL, NULL, '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');

-- 账户-角色 / 用户组
INSERT INTO `sys_iam_relation` VALUES ('8200000000000501', 'ACCOUNT', '8200000000000201', 'ADMIN', 'ACCOUNT_ROLE', 'ROLE', '2', '', 'CASCADE', 'ALL', '[]', 0, 1, 'ENABLED', '', NULL, NULL, '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_iam_relation` VALUES ('8200000000000502', 'ACCOUNT', '8200000000000202', 'ADMIN', 'ACCOUNT_ROLE', 'ROLE', '3', '', 'CASCADE', 'ALL', '[]', 0, 2, 'ENABLED', '', NULL, NULL, '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_iam_relation` VALUES ('8200000000000503', 'ACCOUNT', '8200000000000203', 'ADMIN', 'ACCOUNT_ROLE', 'ROLE', '4', '', 'CASCADE', 'ALL', '[]', 0, 3, 'ENABLED', '', NULL, NULL, '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_iam_relation` VALUES ('8200000000000504', 'ACCOUNT', '8200000000000204', 'ADMIN', 'ACCOUNT_ROLE', 'ROLE', '5', '', 'CASCADE', 'ALL', '[]', 0, 4, 'ENABLED', '', NULL, NULL, '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_iam_relation` VALUES ('8200000000000505', 'ACCOUNT', '8200000000000205', 'ADMIN', 'ACCOUNT_ROLE', 'ROLE', '6', '', 'CASCADE', 'ALL', '[]', 0, 5, 'ENABLED', '', NULL, NULL, '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_iam_relation` VALUES ('8200000000000506', 'ACCOUNT', '8200000000000206', 'ADMIN', 'ACCOUNT_ROLE', 'ROLE', '7', '', 'CASCADE', 'ALL', '[]', 0, 6, 'ENABLED', '', NULL, NULL, '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_iam_relation` VALUES ('8200000000000507', 'ACCOUNT', '8200000000000208', 'ADMIN', 'ACCOUNT_ROLE', 'ROLE', '4', '', 'CASCADE', 'ALL', '[]', 0, 7, 'ENABLED', '', NULL, NULL, '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_iam_relation` VALUES ('8200000000000508', 'ACCOUNT', '8200000000000209', 'ADMIN', 'ACCOUNT_ROLE', 'ROLE', '6', '', 'CASCADE', 'ALL', '[]', 0, 8, 'ENABLED', '', NULL, NULL, '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_iam_relation` VALUES ('8200000000000520', 'ACCOUNT', '8200000000000207', 'ADMIN', 'ACCOUNT_GROUP', 'GROUP', '8200000000000301', '', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '', NULL, NULL, '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_iam_relation` VALUES ('8200000000000521', 'ACCOUNT', '8200000000000203', 'ADMIN', 'ACCOUNT_GROUP', 'GROUP', '8200000000000301', '', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '', NULL, NULL, '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_iam_relation` VALUES ('8200000000000522', 'ACCOUNT', '8200000000000204', 'ADMIN', 'ACCOUNT_GROUP', 'GROUP', '8200000000000304', '', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '', NULL, NULL, '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_iam_relation` VALUES ('8200000000000523', 'ACCOUNT', '8200000000000202', 'ADMIN', 'ACCOUNT_GROUP', 'GROUP', '8200000000000302', '', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '', NULL, NULL, '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_iam_relation` VALUES ('8200000000000524', 'ACCOUNT', '8200000000000201', 'ADMIN', 'ACCOUNT_GROUP', 'GROUP', '8200000000000303', '', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '', NULL, NULL, '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_iam_relation` VALUES ('8200000000000525', 'ACCOUNT', '8200000000000206', 'ADMIN', 'ACCOUNT_GROUP', 'GROUP', '8200000000000303', '', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '', NULL, NULL, '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_iam_relation` VALUES ('8200000000000526', 'ACCOUNT', '8200000000000205', 'ADMIN', 'ACCOUNT_GROUP', 'GROUP', '8200000000000301', '', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '研发副主管加入研发组成员', NULL, NULL, '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_iam_relation` VALUES ('8200000000000527', 'ACCOUNT', '8200000000000208', 'ADMIN', 'ACCOUNT_GROUP', 'GROUP', '8200000000000305', '', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '', NULL, NULL, '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_iam_relation` VALUES ('8200000000000528', 'ACCOUNT', '8200000000000208', 'ADMIN', 'ACCOUNT_GROUP', 'GROUP', '8200000000000301', '', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '后端组兼属研发大组', NULL, NULL, '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_iam_relation` VALUES ('8200000000000529', 'ACCOUNT', '8200000000000209', 'ADMIN', 'ACCOUNT_GROUP', 'GROUP', '8200000000000306', '', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '', NULL, NULL, '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');

-- 角色-资源授权
INSERT INTO `sys_iam_relation` VALUES ('8200000000000601', 'ROLE', '2', 'ADMIN', 'SUBJECT_RESOURCE_GRANT', 'RESOURCE', '200001', '', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '工作台', NULL, NULL, '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_iam_relation` VALUES ('8200000000000602', 'ROLE', '2', 'ADMIN', 'SUBJECT_RESOURCE_GRANT', 'RESOURCE', '200006', '', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '组织权限', NULL, NULL, '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_iam_relation` VALUES ('8200000000000603', 'ROLE', '3', 'ADMIN', 'SUBJECT_RESOURCE_GRANT', 'RESOURCE', '200001', '', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '工作台', NULL, NULL, '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_iam_relation` VALUES ('8200000000000604', 'ROLE', '3', 'ADMIN', 'SUBJECT_RESOURCE_GRANT', 'RESOURCE', '202004', '', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '活动', NULL, NULL, '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_iam_relation` VALUES ('8200000000000605', 'ROLE', '4', 'ADMIN', 'SUBJECT_RESOURCE_GRANT', 'RESOURCE', '200001', '', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '工作台', NULL, NULL, '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_iam_relation` VALUES ('8200000000000606', 'ROLE', '4', 'ADMIN', 'SUBJECT_RESOURCE_GRANT', 'RESOURCE', '202005', '', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '目录', NULL, NULL, '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_iam_relation` VALUES ('8200000000000607', 'ROLE', '5', 'ADMIN', 'SUBJECT_RESOURCE_GRANT', 'RESOURCE', '200001', '', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '工作台', NULL, NULL, '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_iam_relation` VALUES ('8200000000000608', 'ROLE', '5', 'ADMIN', 'SUBJECT_RESOURCE_GRANT', 'RESOURCE', '202006', '', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '订单', NULL, NULL, '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_iam_relation` VALUES ('8200000000000609', 'ROLE', '6', 'ADMIN', 'SUBJECT_RESOURCE_GRANT', 'RESOURCE', '200001', '', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '工作台', NULL, NULL, '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_iam_relation` VALUES ('8200000000000610', 'ROLE', '6', 'ADMIN', 'SUBJECT_RESOURCE_GRANT', 'RESOURCE', '202007', '', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '知识分类', NULL, NULL, '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_iam_relation` VALUES ('8200000000000611', 'ROLE', '7', 'ADMIN', 'SUBJECT_RESOURCE_GRANT', 'RESOURCE', '200007', '', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '账号列表', NULL, NULL, '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');
INSERT INTO `sys_iam_relation` VALUES ('8200000000000612', 'ROLE', '7', 'ADMIN', 'SUBJECT_RESOURCE_GRANT', 'RESOURCE', '201102', '', 'CASCADE', 'ALL', '[]', 0, 0, 'ENABLED', '账号详情', NULL, NULL, '{}', '2026-08-23 08:00:00', '1', '2026-08-23 08:00:00', '1');

-- 业务样例数据
INSERT INTO `cg_test_activity` VALUES ('900000000000000002', 'ACT-RD-01', '研发部活动', 'TRAINING', 'OFFLINE', 'ENABLED', NULL, '研发部 ALL 样例', '2026-08-01 09:00:00', '2026-08-01 18:00:00', 50, 0.00, 1, 0, '{}', '{}', '2026-08-23 08:00:00', '8200000000000202', '2026-08-23 08:00:00', '8200000000000202', '8200000000000102');
INSERT INTO `cg_test_activity` VALUES ('900000000000000003', 'ACT-MKT-01', '市场部活动', 'MARKETING', 'ONLINE', 'ENABLED', NULL, '市场部 ALL 样例', '2026-08-02 09:00:00', '2026-08-02 18:00:00', 100, 0.00, 1, 0, '{}', '{}', '2026-08-23 08:00:00', '8200000000000202', '2026-08-23 08:00:00', '8200000000000202', '8200000000000103');
INSERT INTO `cg_test_catalog` VALUES ('900000000000000104', '900000000000000101', 'RD-CAT', '研发目录', 'SYSTEM', 'ENABLED', 11, 1, 'folder', '研发部目录', '{}', '2026-08-23 08:00:00', '8200000000000203', '2026-08-23 08:00:00', '8200000000000203', '8200000000000102');
INSERT INTO `cg_test_catalog` VALUES ('900000000000000105', '900000000000000101', 'MKT-CAT', '市场目录', 'BUSINESS', 'ENABLED', 21, 1, 'folder', '市场部目录', '{}', '2026-08-23 08:00:00', '8200000000000203', '2026-08-23 08:00:00', '8200000000000203', '8200000000000103');
INSERT INTO `cg_test_catalog` VALUES ('900000000000000106', '900000000000000101', 'BE-CAT', '后端目录', 'SYSTEM', 'ENABLED', 12, 1, 'folder', '后端组目录', '{}', '2026-08-23 08:00:00', '8200000000000208', '2026-08-23 08:00:00', '8200000000000208', '8200000000000105');
INSERT INTO `cg_test_order` VALUES ('900000000000000202', 'CG-ORDER-RD', '研发订单', '张三', '13800002001', 'PAID', 'NORMAL', '2026-08-10 10:00:00', NULL, 100.00, 1, 0, '{}', '研发部订单', '{}', '2026-08-23 08:00:00', '8200000000000203', '2026-08-23 08:00:00', '8200000000000203', '8200000000000102');
INSERT INTO `cg_test_order` VALUES ('900000000000000203', 'CG-ORDER-SELF', '本人订单', '李四', '13800002002', 'PAID', 'NORMAL', '2026-08-11 10:00:00', NULL, 200.00, 1, 0, '{}', '仅本人可见', '{}', '2026-08-23 08:00:00', '8200000000000204', '2026-08-23 08:00:00', '8200000000000204', NULL);
INSERT INTO `cg_test_order` VALUES ('900000000000000204', 'CG-ORDER-OTHER', '他人订单', '王五', '13800002003', 'PAID', 'NORMAL', '2026-08-12 10:00:00', NULL, 300.00, 1, 0, '{}', '他人创建', '{}', '2026-08-23 08:00:00', '8200000000000202', '2026-08-23 08:00:00', '8200000000000202', NULL);
INSERT INTO `cg_test_knowledge_category` VALUES ('900000000000000303', NULL, 'RD-KB', '研发知识库', 'ENABLED', 2, 1, '研发根分类', '{}', '2026-08-23 08:00:00', '8200000000000205', '2026-08-23 08:00:00', '8200000000000205', '8200000000000102');
INSERT INTO `cg_test_knowledge_category` VALUES ('900000000000000304', '900000000000000303', 'RD-FE-KB', '前端知识库', 'ENABLED', 1, 1, '前端子分类', '{}', '2026-08-23 08:00:00', '8200000000000205', '2026-08-23 08:00:00', '8200000000000205', '8200000000000104');
INSERT INTO `cg_test_knowledge_category` VALUES ('900000000000000305', NULL, 'MKT-KB', '市场知识库', 'ENABLED', 3, 1, '市场根分类', '{}', '2026-08-23 08:00:00', '8200000000000205', '2026-08-23 08:00:00', '8200000000000205', '8200000000000103');

-- === AUTH_DEMO_SEED (auto, do not edit) === END

-- === CONTENT_DEMO_SEED (auto, do not edit) ===

-- 展示图
INSERT INTO `sys_banner` VALUES ('8300000000000101', '门户首页欢迎', 'https://images.unsplash.com/photo-1497366216548-37526070297c?w=1600&h=700&fit=crop', '/', 'ROUTE', '欢迎使用 HEI 门户', '门户首页顶部轮播', 'HOME', 'CAROUSEL', 'HOME_TOP', '["PORTAL"]', 5, 0, 'ENABLED', NULL, NULL, '2026-08-23 09:00:00', '1', '2026-08-23 09:00:00', '1');
INSERT INTO `sys_banner` VALUES ('8300000000000102', '活动中心', 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=1600&h=700&fit=crop', '/activities', 'ROUTE', '查看最新活动与报名', '门户活动推广位', 'HOME', 'CAROUSEL', 'HOME_TOP', '["PORTAL"]', 15, 0, 'ENABLED', NULL, NULL, '2026-08-23 09:00:00', '1', '2026-08-23 09:00:00', '1');
INSERT INTO `sys_banner` VALUES ('8300000000000103', '安全合规提示', 'https://images.unsplash.com/photo-1563986768609-322da13575f3?w=1600&h=700&fit=crop', NULL, 'NONE', '请妥善保管账号密码', '门户安全宣传卡片', 'HOME', 'CARD', 'HOME_MIDDLE', '["PORTAL"]', 25, 0, 'ENABLED', NULL, NULL, '2026-08-23 09:00:00', '1', '2026-08-23 09:00:00', '1');
INSERT INTO `sys_banner` VALUES ('8300000000000104', '管理端工作台', 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1600&h=700&fit=crop', '/workspace', 'ROUTE', '快捷进入工作台', '管理端顶部运营位', 'ADMIN_DASHBOARD', 'CAROUSEL', 'ADMIN_TOP', '["ADMIN"]', 5, 0, 'ENABLED', NULL, NULL, '2026-08-23 09:00:00', '1', '2026-08-23 09:00:00', '1');
INSERT INTO `sys_banner` VALUES ('8300000000000105', 'IAM 权限指引', 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=1600&h=700&fit=crop', '/iam/account', 'ROUTE', '组织权限配置入口', '管理端 IAM 引导', 'ADMIN_DASHBOARD', 'CARD', 'ADMIN_SIDE', '["ADMIN"]', 15, 0, 'ENABLED', NULL, NULL, '2026-08-23 09:00:00', '1', '2026-08-23 09:00:00', '1');
INSERT INTO `sys_banner` VALUES ('8300000000000106', '双端同步公告', 'https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=1600&h=700&fit=crop', '/sys/notice', 'ROUTE', '管理端与门户同步消息', '双端可见展示图', 'HOME', 'BANNER', 'GLOBAL_TOP', '["ADMIN", "PORTAL"]', 20, 0, 'ENABLED', NULL, NULL, '2026-08-23 09:00:00', '1', '2026-08-23 09:00:00', '1');

-- 通知消息
INSERT INTO `sys_notice` VALUES ('8300000000000201', 'NOTIFICATION', '门户新手指引', '完成个人资料填写后可解锁更多功能，建议绑定邮箱与手机号。', 'text', 'SYSTEM', 'INFO', 'ALL', '["PORTAL"]', '[]', '[]', '[]', '{}', 0, NULL, NULL, NULL, NULL, NULL, 'PUBLISHED', '2026-08-23 09:00:00', NULL, NULL, 0, '{}', '2026-08-23 09:00:00', '1', '2026-08-23 09:00:00', '1');
INSERT INTO `sys_notice` VALUES ('8300000000000202', 'NOTIFICATION', 'Bob 的专属通知', '这是面向门户账户的示例通知，用于演示消息列表。', 'text', 'SYSTEM', 'INFO', 'ALL', '["PORTAL"]', '[]', '[]', '[]', '{}', 0, NULL, NULL, NULL, NULL, NULL, 'PUBLISHED', '2026-08-23 09:00:00', NULL, NULL, 0, '{}', '2026-08-23 09:00:00', '1', '2026-08-23 09:00:00', '1');
INSERT INTO `sys_notice` VALUES ('8300000000000203', 'ANNOUNCEMENT', '门户春季活动', '春季主题活动已开启，欢迎参与线上打卡与积分兑换。', 'text', 'SYSTEM', 'SUCCESS', 'ALL', '["PORTAL"]', '[]', '[]', '[]', '{"center": true, "workspace": true}', 0, NULL, NULL, NULL, NULL, NULL, 'PUBLISHED', '2026-08-23 09:00:00', NULL, NULL, 3, '{}', '2026-08-23 09:00:00', '1', '2026-08-23 09:00:00', '1');
INSERT INTO `sys_notice` VALUES ('8300000000000204', 'NOTIFICATION', '管理端 IAM 更新', '角色、用户组与部门授权演示数据已就绪，可在组织权限模块查看。', 'text', 'SYSTEM', 'INFO', 'ALL', '["ADMIN"]', '[]', '[]', '[]', '{}', 0, NULL, NULL, NULL, NULL, NULL, 'PUBLISHED', '2026-08-23 09:00:00', NULL, NULL, 0, '{}', '2026-08-23 09:00:00', '1', '2026-08-23 09:00:00', '1');
INSERT INTO `sys_notice` VALUES ('8300000000000205', 'NOTIFICATION', '审计日志提醒', '关键操作将写入审计日志，请管理员定期查看异常登录与权限变更。', 'text', 'SECURITY', 'WARNING', 'ALL', '["ADMIN"]', '[]', '[]', '[]', '{}', 0, NULL, NULL, NULL, NULL, NULL, 'PUBLISHED', '2026-08-23 09:00:00', NULL, NULL, 0, '{}', '2026-08-23 09:00:00', '1', '2026-08-23 09:00:00', '1');
INSERT INTO `sys_notice` VALUES ('8300000000000206', 'ANNOUNCEMENT', '管理端版本说明', '本次演示环境包含完整 IAM 与内容运营模块，仅供本地开发验证。', 'text', 'SYSTEM', 'INFO', 'ALL', '["ADMIN"]', '[]', '[]', '[]', '{"workspace": true}', 1, NULL, NULL, NULL, NULL, NULL, 'PUBLISHED', '2026-08-23 09:00:00', NULL, NULL, 2, '{}', '2026-08-23 09:00:00', '1', '2026-08-23 09:00:00', '1');
INSERT INTO `sys_notice` VALUES ('8300000000000207', 'NOTIFICATION', '双端系统通知', '管理端与门户均可收到本条通知，用于验证目标账户类型多选。', 'text', 'SYSTEM', 'INFO', 'ALL', '["ADMIN", "PORTAL"]', '[]', '[]', '[]', '{}', 0, NULL, NULL, NULL, NULL, NULL, 'PUBLISHED', '2026-08-23 09:00:00', NULL, NULL, 0, '{}', '2026-08-23 09:00:00', '1', '2026-08-23 09:00:00', '1');
INSERT INTO `sys_notice` VALUES ('8300000000000208', 'NOTIFICATION', '待处理反馈提醒', '有新的用户反馈待处理，请前往反馈管理查看。', 'text', 'SYSTEM', 'WARNING', 'ALL', '["ADMIN"]', '[]', '[]', '[]', '{}', 0, NULL, NULL, NULL, NULL, NULL, 'PUBLISHED', '2026-08-23 09:00:00', NULL, NULL, 0, '{}', '2026-08-23 09:00:00', '1', '2026-08-23 09:00:00', '1');

-- 反馈（按账户类型分组演示）
INSERT INTO `sys_feedback` VALUES ('8300000000000301', '门户登录体验', '希望增加短信验证码登录选项。', 'SUGGESTION', 'bob@demo.local', '[]', 'PENDING', NULL, NULL, NULL, 'PORTAL', '8200000000000211', '2026-08-23 09:00:00', '8200000000000211', '2026-08-23 09:00:00', '8200000000000211');
INSERT INTO `sys_feedback` VALUES ('8300000000000302', '活动页面加载慢', '活动列表在弱网下加载超过 5 秒。', 'BUG', '13800001001', '[]', 'PENDING', NULL, NULL, NULL, 'PORTAL', '8200000000000211', '2026-08-23 09:00:00', '8200000000000211', '2026-08-23 09:00:00', '8200000000000211');
INSERT INTO `sys_feedback` VALUES ('8300000000000303', '个人中心样式问题', '头像上传后预览区域会抖动。', 'BUG', 'alice@demo.local', '[]', 'RESOLVED', '已记录，将在下个版本修复。', '1', '2026-08-23 09:00:00', 'PORTAL', '8200000000000212', '2026-08-23 09:00:00', '8200000000000212', '2026-08-23 09:00:00', '8200000000000212');
INSERT INTO `sys_feedback` VALUES ('8300000000000304', '希望增加深色模式', '门户夜间使用较刺眼，建议支持深色主题。', 'SUGGESTION', 'alice@demo.local', '[]', 'PENDING', NULL, NULL, NULL, 'PORTAL', '8200000000000212', '2026-08-23 09:00:00', '8200000000000212', '2026-08-23 09:00:00', '8200000000000212');
INSERT INTO `sys_feedback` VALUES ('8300000000000305', '历史门户反馈', '早期门户测试账号提交的反馈样例。', 'GENERAL', '13800000000', '[]', 'RESOLVED', 'ok', '1', '2026-08-08 13:40:49.757811', 'PORTAL', '7491847383584804864', '2026-08-23 09:00:00', '7491847383584804864', '2026-08-23 09:00:00', '7491847383584804864');
INSERT INTO `sys_feedback` VALUES ('8300000000000306', '部门树展示优化', '建议部门详情中直接展示成员数量。', 'SUGGESTION', 'iam-admin@demo.local', '[]', 'PENDING', NULL, NULL, NULL, 'ADMIN', '8200000000000201', '2026-08-23 09:00:00', '8200000000000201', '2026-08-23 09:00:00', '8200000000000201');
INSERT INTO `sys_feedback` VALUES ('8300000000000307', '角色授权交互', '授权用户弹窗希望支持按部门筛选。', 'SUGGESTION', 'biz-all@demo.local', '[]', 'PENDING', NULL, NULL, NULL, 'ADMIN', '8200000000000202', '2026-08-23 09:00:00', '8200000000000202', '2026-08-23 09:00:00', '8200000000000202');
INSERT INTO `sys_feedback` VALUES ('8300000000000308', '只读账号权限确认', '只读账号不应看到删除按钮，请确认前端权限控制。', 'BUG', 'readonly@demo.local', '[]', 'RESOLVED', '已确认，仅隐藏无权限按钮。', '1', '2026-08-23 09:00:00', 'ADMIN', '8200000000000206', '2026-08-23 09:00:00', '8200000000000206', '2026-08-23 09:00:00', '8200000000000206');

-- === CONTENT_DEMO_SEED (auto, do not edit) === END
