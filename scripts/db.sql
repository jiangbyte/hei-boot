...
INSERT INTO "public"."sys_config" VALUES ('cfg_1be5b5a733cdb21b', 'AUDIT_ALERT_RULE_BULK_DELETE', 'TRUE', 'AUDIT_ALERT', '批量删除检测（暂未实现，配置页已隐藏）', 13, 'BOOL', '批量删除检测', NULL, NULL, 'f', '{}', '2026-08-08 00:00:00+00', NULL, '2026-08-08 00:00:00+00', NULL);
INSERT INTO "public"."sys_config" VALUES ('cfg_28c8a4a855e9fad1', 'AUDIT_ALERT_IP_ANOMALY_THRESHOLD', '3', 'AUDIT_ALERT', 'IP异常阈值（暂未实现，配置页已隐藏）', 22, 'INT', 'IP异常阈值', NULL, NULL, 'f', '{}', '2026-08-08 00:00:00+00', NULL, '2026-08-08 00:00:00+00', NULL);
INSERT INTO "public"."sys_config" VALUES ('cfg_452a32888fa5d2f8', 'AUDIT_ALERT_RULE_IP_ANOMALY', 'TRUE', 'AUDIT_ALERT', 'IP 异常检测（暂未实现，配置页已隐藏）', 14, 'BOOL', 'IP 异常检测', NULL, NULL, 'f', '{}', '2026-08-08 00:00:00+00', NULL, '2026-08-08 00:00:00+00', NULL);
...
INSERT INTO "public"."sys_config" VALUES ('cfg_3ec435822ae2d002', 'AUTH_REGISTER_PORTAL_REQUIRE_EMAIL', 'TRUE', 'AUTH_REGISTER', '已废弃：请使用 AUTH_REGISTER_PORTAL_ALLOW_EMAIL', 8, 'BOOL', 'PORTAL 注册要求邮箱', 'PORTAL', NULL, 'f', '{}', '2026-08-08 00:00:00+00', NULL, '2026-08-08 00:00:00+00', NULL);
...
INSERT INTO "public"."sys_config" VALUES ('cfg_7135b647c2b3c035', 'AUTH_REGISTER_PORTAL_REQUIRE_PHONE', 'FALSE', 'AUTH_REGISTER', '已废弃：请使用 AUTH_REGISTER_PORTAL_ALLOW_PHONE / AUTH_FORCE_BIND_*', 7, 'BOOL', 'PORTAL 注册不要求手机', 'PORTAL', NULL, 'f', '{}', '2026-08-08 00:00:00+00', NULL, '2026-08-08 00:00:00+00', NULL);
INSERT INTO "public"."sys_config" VALUES ('cfg_4c6acf8e5e9275d9', 'AUTH_REGISTER_ADMIN_REQUIRE_PHONE', 'FALSE', 'AUTH_REGISTER', '已废弃：管理员无自助注册', 2, 'BOOL', 'ADMIN 注册要求手机号', 'ADMIN', NULL, 'f', '{}', '2026-08-08 00:00:00+00', NULL, '2026-08-08 00:00:00+00', NULL);
INSERT INTO "public"."sys_config" VALUES ('cfg_6706c37cfca883e5', 'AUTH_REGISTER_ADMIN_REQUIRE_EMAIL', 'FALSE', 'AUTH_REGISTER', '已废弃：管理员无自助注册', 3, 'BOOL', 'ADMIN 注册要求邮箱', 'ADMIN', NULL, 'f', '{}', '2026-08-08 00:00:00+00', NULL, '2026-08-08 00:00:00+00', NULL);
...
INSERT INTO "public"."sys_config" VALUES ('cfg_8394da8a8cca0551', 'AUDIT_ALERT_RULE_SENSITIVE_OPS', 'TRUE', 'AUDIT_ALERT', '敏感操作监控（暂未实现，配置页已隐藏）', 12, 'BOOL', '敏感操作监控', NULL, NULL, 'f', '{}', '2026-08-08 00:00:00+00', NULL, '2026-08-08 00:00:00+00', NULL);
INSERT INTO "public"."sys_config" VALUES ('cfg_88059105f3bfd3bd', 'AUDIT_ALERT_RULE_UNUSUAL_HOURS', 'TRUE', 'AUDIT_ALERT', '异常时间操作检测（暂未实现，配置页已隐藏）', 11, 'BOOL', '异常时间操作检测', NULL, NULL, 'f', '{}', '2026-08-08 00:00:00+00', NULL, '2026-08-08 00:00:00+00', NULL);
INSERT INTO "public"."sys_config" VALUES ('cfg_a4e7a42d3948bf0b', 'AUDIT_ALERT_BULK_DELETE_THRESHOLD', '20', 'AUDIT_ALERT', '批量删除阈值（暂未实现，配置页已隐藏）', 21, 'INT', '批量删除阈值', NULL, NULL, 'f', '{}', '2026-08-08 00:00:00+00', NULL, '2026-08-08 00:00:00+00', NULL);
