...
INSERT INTO "public"."sys_job" VALUES ('7541000000000000007', '任务执行日志清理', 'github.jiangbyte.io.sys.modules.job.cleanup.SysJobLogCleanupJob', 'CRON', '0 30 3 * * *', '{"retentionDays": 30, "batchSize": 1000}', NULL, now(), NULL, 't', '按保留天数批量清理过期 sys_job_log', 7, now(), NULL, now(), NULL);
...
CREATE INDEX "idx_sys_job_log_execute_time" ON "public"."sys_job_log" USING btree ("execute_time");
...
INSERT INTO "public"."sys_config" VALUES ('cfg_sto_aliyun_pub', 'STORAGE_ALIYUN_BUCKET_PUBLIC', 'FALSE', 'STORAGE', '阿里云桶是否公开', 14, 'BOOL', NULL, NULL, NULL, 'f', '{}', '2026-08-08 00:00:00+00', NULL, '2026-08-08 00:00:00+00', '1');
...
INSERT INTO "public"."sys_config" VALUES ('cfg_sto_tencent_pub', 'STORAGE_TENCENT_BUCKET_PUBLIC', 'FALSE', 'STORAGE', '腾讯云桶是否公开', 20, 'BOOL', NULL, NULL, NULL, 'f', '{}', '2026-08-08 00:00:00+00', NULL, '2026-08-08 00:00:00+00', '1');
...
INSERT INTO "public"."sys_config" VALUES ('cfg_sto_minio_pub', 'STORAGE_MINIO_BUCKET_PUBLIC', 'FALSE', 'STORAGE', 'MinIO 桶是否公开', 26, 'BOOL', NULL, NULL, NULL, 'f', '{}', '2026-08-08 00:00:00+00', NULL, '2026-08-08 00:00:00+00', '1');
...
INSERT INTO "public"."sys_config" VALUES ('cfg_sto_rustfs_pub', 'STORAGE_RUSTFS_BUCKET_PUBLIC', 'FALSE', 'STORAGE', 'RustFS 桶是否公开', 47, 'BOOL', NULL, NULL, NULL, 'f', '{}', '2026-08-09 00:00:00+00', NULL, '2026-08-09 00:00:00+00', '1');
...
INSERT INTO "public"."sys_config" VALUES ('cfg_oauth_frontend_portal_cb', 'AUTH_OAUTH_FRONTEND_CALLBACK_PORTAL', 'http://localhost:5174/auth/oauth/callback', 'AUTH_OAUTH', '门户 OAuth 前端回调页（空则用默认）', 200, 'STRING', '门户前端回调', NULL, NULL, 'f', '{}', '2026-08-12 15:57:59.540869+00', NULL, '2026-08-12 15:57:59.540869+00', '1');
INSERT INTO "public"."sys_config" VALUES ('cfg_oauth_frontend_admin_cb', 'AUTH_OAUTH_FRONTEND_CALLBACK_ADMIN', 'http://localhost:5173/auth/oauth/callback', 'AUTH_OAUTH', '管理端 OAuth 前端回调页（空则用默认）', 201, 'STRING', '管理端前端回调', NULL, NULL, 'f', '{}', '2026-08-12 15:57:59.544738+00', NULL, '2026-08-12 15:57:59.544738+00', '1');
...
-- Records of sys_file
-- ----------------------------
INSERT INTO "public"."sys_file" VALUES ('7491869364283744256', 'uploads/2026/08/08/93c4b0dba86f483bb1905ba079550521.png', 'QR2026080700024_1786146767761.png', 'minio', 'vms', 'image/png', 38636, 'uploads/2026/08/08/93c4b0dba86f483bb1905ba079550521.png', '2026-08-08 14:54:08.592047+00', '1', '2026-08-08 14:54:08.592047+00', '1');
INSERT INTO "public"."sys_file" VALUES ('7491906012023353344', 'uploads/2026/08/08/0e535c4dc69241eab526c5e94d9eb19b.png', 'QR2026080700024_1786146767761.png', 'rustfs', 'defaultbucket', 'image/png', 38636, 'uploads/2026/08/08/0e535c4dc69241eab526c5e94d9eb19b.png', '2026-08-08 17:19:46.108576+00', '1', '2026-08-08 17:19:46.108576+00', '1');
...
INSERT INTO "public"."sys_file" VALUES ('2086410328867565570', 'uploads/2026/08/09/02acc3dee5454d34913b07f49fe59cac.png', 'avatar.png', 'rustfs', 'defaultbucket', 'image/png', 193387, 'uploads/2026/08/09/02acc3dee5454d34913b07f49fe59cac.png', '2026-08-09 11:12:40.692242+00', '1', '2026-08-09 11:12:40.692242+00', '1');
INSERT INTO "public"."sys_file" VALUES ('2086415187620601857', 'uploads/2026/08/09/85e1b98acfc9465abbbba86ef3b4fec8.jpg', '120153703_touxiang_bobopic (1).jpg', 'rustfs', 'defaultbucket', 'image/jpeg', 65451, 'uploads/2026/08/09/85e1b98acfc9465abbbba86ef3b4fec8.jpg', '2026-08-09 11:31:59.117567+00', '1', '2026-08-09 11:31:59.117567+00', '1');
