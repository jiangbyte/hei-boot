package github.jiangbyte.io.profile.modules.admin.convert;
...
public interface ProfileUserAdminConvert {
    ...
    UserProfileResult toDto(ProfileUserAdmin profile);

    /** 实体转为跨模块 Info。 */
    @BeanMapping(unmappedTargetPolicy = ReportingPolicy.IGNORE)
    ProfileUserAdminInfo toInfo(ProfileUserAdmin profile);
    ...
    void updateInfo(ProfileUserAdminInfo info, @MappingTarget ProfileUserAdmin profile);
    ...
    void update(ProfileUpdateParam request, @MappingTarget ProfileUserAdmin profile);
}
