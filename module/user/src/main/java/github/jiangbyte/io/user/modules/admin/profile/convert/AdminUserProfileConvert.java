package github.jiangbyte.io.user.modules.admin.profile.convert;
...
/**
 * 管理端用户资料对象转换：实体 / Info / 请求参数与 me、资料 DTO 之间的 MapStruct 映射。
 *
 * Author: Charlie
 */
@Mapper(componentModel = MappingConstants.ComponentModel.SPRING)
public interface AdminUserProfileConvert {
    ...
    UserProfileResult toDto(AdminUserProfile profile);

    /** 实体转为跨模块 Info。 */
    @BeanMapping(unmappedTargetPolicy = ReportingPolicy.IGNORE)
    AdminUserProfileInfo toInfo(AdminUserProfile profile);
    ...
    void updateInfo(AdminUserProfileInfo info, @MappingTarget AdminUserProfile profile);
    ...
    void update(ProfileUpdateParam request, @MappingTarget AdminUserProfile profile);
}
